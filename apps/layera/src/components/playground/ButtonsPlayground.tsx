            ...
            <Box className="layera-space-y--md layera-margin-bottom--lg">
              ...
              <Box className="layera-border--solid layera-border-width--1 layera-border-color--primary layera-border-radius--md">
                <Box
                  ...
                  onClick={() => toggleCategory('backgroundColors')}
                >
                ...
                {expandedCategories.backgroundColors && (
                  <Box className="layera-padding--md">
                    <Box className="layera-overflow--auto layera-width--full">
              ...
              <Box className="layera-border--solid layera-border-width--1 layera-border-color--primary layera-border-radius--md">
                <Box
                  className="layera-padding--md layera-cursor--pointer layera-bg--surface-primary layera-border-bottom--dashed layera-border-width--1 layera-border-color--primary"
                  onClick={() => toggleCategory('borders')}
                >
                  <Box className="layera-display--flex layera-items-center layera-justify-between">
                    <Text className="layera-typography" data-size="md" data-weight="bold" data-color="primary">
                        ...
                        <tbody>
                          <tr className="layera-border-bottom--dashed layera-border-width--1 layera-border-color--warning">
                            ...
                            <CopyButton
                              ...
                              currentValue={String(borderWidth)}
                            />
                          </tr>
                          <tr className="layera-border-bottom--dashed layera-border-width--1 layera-border-color--danger">
                            <td className="layera-padding--sm layera-border-right--dashed layera-border-width--1 layera-border-color--danger">
              ...
              <Box className="layera-border--solid layera-border-width--1 layera-border-color--primary layera-border-radius--md">
                <Box
                  className="layera-padding--md layera-cursor--pointer layera-bg--surface-primary layera-border-bottom--dashed layera-border-width--1 layera-border-color--primary"
                  onClick={() => toggleCategory('shadowsEffects')}
                >
                  <Box className="layera-display--flex layera-items-center layera-justify-between">
                    <Text className="layera-typography" data-size="md" data-weight="bold" data-color="primary">
              ...
              <Box className="layera-border--solid layera-border-width--1 layera-border-color--primary layera-border-radius--md">
                <Box
                  className="layera-padding--md layera-cursor--pointer layera-bg--surface-primary layera-border-bottom--dashed layera-border-width--1 layera-border-color--primary"
                  onClick={() => toggleCategory('layoutSpacing')}
                >
                  <Box className="layera-display--flex layera-items-center layera-justify-between">
                    <Text className="layera-typography" data-size="md" data-weight="bold" data-color="primary">
              ...
              <Box className="layera-border--solid layera-border-width--1 layera-border-color--primary layera-border-radius--md">
                <Box
                  className="layera-padding--md layera-cursor--pointer layera-bg--surface-primary layera-border-bottom--dashed layera-border-width--1 layera-border-color--primary"
                  onClick={() => toggleCategory('typography')}
                >
                  <Box className="layera-display--flex layera-items-center layera-justify-between">
                    <Text className="layera-typography" data-size="md" data-weight="bold" data-color="primary">
                      ...
                      <table className="layera-table layera-table-compact layera-width--full layera-border--solid layera-border-width--1 layera-border-color--secondary layera-border-radius--md">
                        ...
                        <thead className="layera-bg--surface-secondary">
                          <tr className="layera-bg--surface-secondary">
                            ...
                            <th className="layera-padding--sm layera-text-align--left layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-weight="bold" data-color="primary">CSS Μεταβλητή</Text>
                            </th>
                            <th className="layera-padding--sm layera-text-align--left layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-weight="bold" data-color="primary">Selector</Text>
                            </th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-font-size="{buttonState.size}"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                          ...
                          <tr className="layera-bg--surface-primary">
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-font-weight="auto/defined"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                          ...
                          <tr className="layera-bg--surface-primary">
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">.layera-button .button-text</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-text="{buttonState.text}"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                      ...
                      <table className="layera-table layera-table-compact layera-width--full layera-border--solid layera-border-width--1 layera-border-color--secondary layera-border-radius--md">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">.layera-button .icon</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-icon-size="{buttonState.size}"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                          ...
                          <tr className="layera-bg--surface-primary">
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-icon-position="left/right"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                          ...
                          <tr>
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-with-icon="{buttonState.withIcon}"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
              ...
              <Box className="layera-border--solid layera-border-width--1 layera-border-color--primary layera-border-radius--md">
                <Box
                  className="layera-padding--md layera-cursor--pointer layera-bg--surface-primary layera-border-bottom--dashed layera-border-width--1 layera-border-color--primary"
                  onClick={() => toggleCategory('statesAccessibility')}
                >
                  <Box className="layera-display--flex layera-items-center layera-justify-between">
                    <Text className="layera-typography" data-size="md" data-weight="bold" data-color="primary">
                      ...
                      <table className="layera-table layera-table-compact layera-width--full layera-border--solid layera-border-width--1 layera-border-color--secondary layera-border-radius--md">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">.layera-button:focus</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-focus="true/false"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                          ...
                          <tr className="layera-bg--surface-primary">
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">.layera-button:disabled</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-disabled="true/false"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-weight="bold" data-color="success">var(--layera-button-disabled-opacity)</Text>
                            </td>
                            <CopyButton
                          ...
                          <tr>
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">.layera-button .spinner</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-loading="true/false"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
              ...
              {/* ⚙️ Current Configuration Section */}
              <Box className="layera-border--solid layera-border-width--1 layera-border-color--primary layera-border-radius--md">
                <Box
                  className="layera-padding--md layera-cursor--pointer layera-bg--surface-primary layera-border-bottom--dashed layera-border-width--1 layera-border-color--primary"
                  onClick={() => toggleCategory('currentConfiguration')}
                >
                  <Box className="layera-display--flex layera-items-center layera-justify-between">
                    <Text className="layera-typography" data-size="md" data-weight="bold" data-color="primary">
                      ...
                      <table className="layera-table layera-table-compact layera-width--full layera-border--solid layera-border-width--1 layera-border-color--secondary layera-border-radius--md">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-shape="{buttonState.shape}"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                          ...
                          <tr>
                            ...
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">
                              <Text className="layera-typography" data-size="sm" data-color="secondary">data-element="button"</Text>
                            </td>
                            <td className="layera-padding--sm layera-border--solid layera-border-width--1 layera-border-color--primary">

...
const HomePage: React.FC = () => {
  ...
  return (
    <Box className="layera-full-height layera-container--fullscreen">
      ...
      <Box className="layera-full-height la-bg-gradient-primary layera-container--fullscreen layera-flex layera-flex--center layera-flex--align-center">
        <Box className="la-card la-bg-primary layera-padding--xl layera-container--constrained">
          <Stack className="layera-text-center layera-stack--spacing-lg">
            ...
            <Flex className="layera-grid layera-grid--cols-1 layera-grid--tablet-cols-2 layera-grid--gap-lg">
              <Link
                to="/marketplace"
                className="layera-padding--lg la-bg-surface-medium la-card-accent-primary"
              >
              ...
              <Link
                to="/jobs"
                className="layera-padding--lg la-bg-surface-medium la-card-accent-green"
              >
                <Box className="la-text-4xl layera-margin-bottom--md">

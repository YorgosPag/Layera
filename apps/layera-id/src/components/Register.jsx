...
import { FORM_TYPES, FORM_SIZES, getCardInfoColor, getCardInfoBorder } from '@layera/constants';
import './Auth.css';
  ...
  return (
    <Box className="auth-container">
      <BaseCard
        ...
        style={{
          backgroundColor: getCardInfoColor(), // 🔴 SST: Register form color από μοναδική πηγή αλήθειας

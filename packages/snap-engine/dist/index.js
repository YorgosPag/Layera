...
var knn__default = /*#__PURE__*/_interopDefault(knn);
...
var RTreeSpatialIndex = class {
  constructor(options = {}) {
    ...
    this.tree = new RBush__default.default(this.options.maxEntries);
  ...
  findKNearest(point, k = 5) {
    try {
      const results = knn__default.default(this.tree, point.x, point.y, k);
      return results.map((item) => item.geometry);
    } catch (error) {
...
exports.DEFAULT_SNAP_CONFIG = DEFAULT_SNAP_CONFIG;
exports.DEFAULT_SPATIAL_OPTIONS = DEFAULT_SPATIAL_OPTIONS;
exports.GeometryUtils = GeometryUtils;
exports.PERFORMANCE_CONFIGS = PERFORMANCE_CONFIGS;
exports.RTreeSpatialIndex = RTreeSpatialIndex;
exports.SNAP_TYPES = SNAP_TYPES;
exports.SnapCalculator = SnapCalculator;
exports.SnapEngine = SnapEngine;
exports.VERSION = VERSION;
exports.createCADSnapEngine = createCADSnapEngine;
exports.createGISSnapEngine = createGISSnapEngine;
exports.createGeometry = createGeometry;
exports.createMobileSnapEngine = createMobileSnapEngine;
exports.default = index_default;
exports.validateSnapConfig = validateSnapConfig;

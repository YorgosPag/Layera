...
export const BOX_SHADOW_SCALE = {
  ...
  elevation7: 'var(--la-shadow-overlay, 0 35px 60px -12px rgba(0, 0, 0, 0.35))', // Full-screen overlay
  ...
  // Input elements
  inputDefault: 'var(--la-shadow-input, 0 1px 2px 0 rgba(0, 0, 0, 0.05))', // Input at rest
  inputFocus: 'var(--la-shadow-input-focus, 0 0 0 3px rgba(59, 130, 246, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.05))', // Input focused

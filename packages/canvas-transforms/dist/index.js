...
__export(src_exports, {
  ...
  applyMatrixToContext: () => applyMatrixToContext,
  compose: () => compose,
  convertCoordinates: () => convertCoordinates,
  createCanvasCoordinateMapping: () => createCanvasCoordinateMapping,
  createCoordinateMapping: () => createCoordinateMapping,
  createIdentityMatrix: () => createIdentityMatrix,
  createRotationAroundPointMatrix: () => createRotationAroundPointMatrix,
  ...
  matrixToCSSTransform: () => matrixToCSSTransform,
  matrixToSVGTransform: () => matrixToSVGTransform,
  measureText: () => measureText,
  multiplyMatrices: () => multiplyMatrices,
  setupHighDPICanvas: () => setupHighDPICanvas,
  transformBoundingBox: () => transformBoundingBox,

...
var require_dist = __commonJS({
  "../constants/dist/index.js"(exports2, module2) {
    "use strict";
    ...
    var require_react_production = __commonJS2({
      "../../node_modules/.pnpm/react@19.2.0/node_modules/react/cjs/react.production.js"(exports22) {
        "use strict";
        ...
        exports22.Activity = REACT_ACTIVITY_TYPE;
        exports22.Children = Children;
        exports22.Component = Component;
        exports22.Fragment = REACT_FRAGMENT_TYPE;
        exports22.Profiler = REACT_PROFILER_TYPE;
        exports22.PureComponent = PureComponent;
        exports22.StrictMode = REACT_STRICT_MODE_TYPE;
        exports22.Suspense = REACT_SUSPENSE_TYPE;
        exports22.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = ReactSharedInternals;
        exports22.__COMPILER_RUNTIME = {
          __proto__: null,
          c: function(size) {
            return ReactSharedInternals.H.useMemoCache(size);
          }
        };
        exports22.cache = function(fn) {
          return function() {
            return fn.apply(null, arguments);
          };
        };
        exports22.cacheSignal = function() {
          return null;
        };
        exports22.cloneElement = function(element, config, children) {
        ...
        exports22.createContext = function(defaultValue) {
          defaultValue = {
        ...
        exports22.createElement = function(type, config, children) {
        ...
        exports22.createRef = function() {
          return { current: null };
        };
        exports22.forwardRef = function(render) {
          return { $$typeof: REACT_FORWARD_REF_TYPE, render };
        };
        exports22.isValidElement = isValidElement;
        exports22.lazy = function(ctor) {
          return {
        ...
        exports22.memo = function(type, compare) {
          return {
        ...
        exports22.startTransition = function(scope) {
        ...
        exports22.unstable_useCacheRefresh = function() {
          return ReactSharedInternals.H.useCacheRefresh();
        };
        exports22.use = function(usable) {
          return ReactSharedInternals.H.use(usable);
        };
        exports22.useActionState = function(action, initialState, permalink) {
          return ReactSharedInternals.H.useActionState(action, initialState, permalink);
        };
        exports22.useCallback = function(callback, deps) {
          return ReactSharedInternals.H.useCallback(callback, deps);
        };
        exports22.useContext = function(Context) {
          return ReactSharedInternals.H.useContext(Context);
        };
        exports22.useDebugValue = function() {
        };
        exports22.useDeferredValue = function(value, initialValue) {
          return ReactSharedInternals.H.useDeferredValue(value, initialValue);
        };
        exports22.useEffect = function(create, deps) {
          return ReactSharedInternals.H.useEffect(create, deps);
        };
        exports22.useEffectEvent = function(callback) {
          return ReactSharedInternals.H.useEffectEvent(callback);
        };
        exports22.useId = function() {
          return ReactSharedInternals.H.useId();
        };
        exports22.useImperativeHandle = function(ref, create, deps) {
          return ReactSharedInternals.H.useImperativeHandle(ref, create, deps);
        };
        exports22.useInsertionEffect = function(create, deps) {
          return ReactSharedInternals.H.useInsertionEffect(create, deps);
        };
        exports22.useLayoutEffect = function(create, deps) {
          return ReactSharedInternals.H.useLayoutEffect(create, deps);
        };
        exports22.useMemo = function(create, deps) {
          return ReactSharedInternals.H.useMemo(create, deps);
        };
        exports22.useOptimistic = function(passthrough, reducer) {
          return ReactSharedInternals.H.useOptimistic(passthrough, reducer);
        };
        exports22.useReducer = function(reducer, initialArg, init) {
          return ReactSharedInternals.H.useReducer(reducer, initialArg, init);
        };
        exports22.useRef = function(initialValue) {
          return ReactSharedInternals.H.useRef(initialValue);
        };
        exports22.useState = function(initialState) {
          return ReactSharedInternals.H.useState(initialState);
        };
        exports22.useSyncExternalStore = function(subscribe, getSnapshot, getServerSnapshot) {
        ...
        exports22.useTransition = function() {
          return ReactSharedInternals.H.useTransition();
        };
        exports22.version = "19.2.0";
      }
    });
    var require_react_development = __commonJS2({
      "../../node_modules/.pnpm/react@19.2.0/node_modules/react/cjs/react.development.js"(exports22, module22) {
        "use strict";
        "production" !== process.env.NODE_ENV && function() {
          ...
          function enqueueTask(task) {
            if (null === enqueueTaskImpl)
              try {
                ...
                enqueueTaskImpl = (module22 && module22[requireString]).call(
                  module22,
                  "timers"
                ).setImmediate;
              } catch (_err) {
          ...
          exports22.Suspense = REACT_SUSPENSE_TYPE;
          exports22.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = ReactSharedInternals;
          exports22.__COMPILER_RUNTIME = deprecatedAPIs;
          exports22.act = function(callback) {
          ...
          exports22.captureOwnerStack = function() {
          ...
          exports22.useDebugValue = function(value, formatterFn) {
    ...
    var require_react = __commonJS2({
      "../../node_modules/.pnpm/react@19.2.0/node_modules/react/index.js"(exports22, module22) {
        "use strict";
        if (process.env.NODE_ENV === "production") {
          module22.exports = require_react_production();
        } else {
          module22.exports = require_react_development();
        }
      }
    });
    var require_react_jsx_runtime_production = __commonJS2({
      "../../node_modules/.pnpm/react@19.2.0/node_modules/react/cjs/react-jsx-runtime.production.js"(exports22) {
        "use strict";
        var REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element");
        var REACT_FRAGMENT_TYPE = Symbol.for("react.fragment");
        ...
        exports22.Fragment = REACT_FRAGMENT_TYPE;
        exports22.jsx = jsxProd;
        exports22.jsxs = jsxProd;
      }
    });
    var require_react_jsx_runtime_development = __commonJS2({
      "../../node_modules/.pnpm/react@19.2.0/node_modules/react/cjs/react-jsx-runtime.development.js"(exports22) {
        "use strict";
        "production" !== process.env.NODE_ENV && function() {
          function getComponentNameFromType(type) {
            if (null == type)
          ...
          exports22.Fragment = REACT_FRAGMENT_TYPE;
          exports22.jsx = function(type, config, maybeKey) {
          ...
          exports22.jsxs = function(type, config, maybeKey) {
            var trackActualOwner = 1e4 > ReactSharedInternals.recentlyCreatedOwnerStacks++;
            return jsxDEVImpl(
              type,
              config,
    ...
    var require_jsx_runtime = __commonJS2({
      "../../node_modules/.pnpm/react@19.2.0/node_modules/react/jsx-runtime.js"(exports22, module22) {
        "use strict";
        if (process.env.NODE_ENV === "production") {
          module22.exports = require_react_jsx_runtime_production();
        } else {
          module22.exports = require_react_jsx_runtime_development();
        }
      }
    });
    var index_exports = {};
...
__export(src_exports, {
  AppShell: () => AppShell,
  Box: () => Box,
  COMPLETE_FLEX_SYSTEM: () => COMPLETE_FLEX_SYSTEM,
  FLEX_CSS_VARS: () => FLEX_CSS_VARS,
  FLEX_SCALE: () => FLEX_SCALE,
  FLEX_UTILITIES: () => FLEX_UTILITIES,
  Flex: () => Flex,
  GEOALERT_LAYOUT_CONFIG: () => GEOALERT_LAYOUT_CONFIG,
  HeaderActionsGroup: () => HeaderActionsGroup,
  LayeraHeader: () => LayeraHeader,
  PageContainer: () => PageContainer,
  PageHeader: () => PageHeader,
  RESPONSIVE_SIZING: () => RESPONSIVE_SIZING,
  SIZING_CSS_VARS: () => SIZING_CSS_VARS,
  SIZING_SCALE: () => SIZING_SCALE,
  SIZING_UTILITIES: () => SIZING_UTILITIES,
  Stack: () => Stack,
  calculateGeoAlertPositions: () => calculateGeoAlertPositions,
  createGeoAlertCardStyles: () => createGeoAlertCardStyles,
  createGeoAlertInfoPanelStyles: () => createGeoAlertInfoPanelStyles,
  getFlexVar: () => getFlexVar,
  getSizingValue: () => getSizingValue,
  getSizingVar: () => getSizingVar,
  updateGeoAlertLayoutVariables: () => updateGeoAlertLayoutVariables,
  useFlex: () => useFlex,
  useFlexItem: () => useFlexItem,
  useFlexPatterns: () => useFlexPatterns,
  useFlexSystem: () => useFlexSystem,
  useGeoAlertLayout: () => useGeoAlertLayout,
  useResponsiveFlex: () => useResponsiveFlex,
  useResponsiveSizing: () => useResponsiveSizing,
  useSizing: () => useSizing,
  useSizingStyles: () => useSizingStyles,
  useSizingSystem: () => useSizingSystem,
  useSizingTokens: () => useSizingTokens
});
...
var Stack = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className, style: stackStyles, children });
};
...
var Flex = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className, style: flexStyles, children });
};
...
var Box = ({
  ...
  const boxStyles = (0, import_react2.useMemo)(() => {
    return {
      // Sizing properties
...
var PageContainer = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: containerClasses, style: styles, children });
};
...
var PageHeader = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("header", { className: headerClasses, style: styles, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h1", { style: titleStyles, children: title }),
      subtitle && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: subtitleStyles, children: subtitle }),
      children
    ] }),
    actions && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { display: "flex", gap: "0.5rem", alignItems: "center" }, children: actions })
  ] });
};
...
function useGeoAlertLayout(customConfig) {
  ...
  const positions = (0, import_react3.useMemo)(
    () => calculateGeoAlertPositions(config),
    [config]
  );
  const isMobile = (0, import_react3.useMemo)(() => {
    if (typeof window === "undefined")
      return false;
    return window.innerWidth <= 768;
  }, []);
  const getCardStyles = (0, import_react3.useCallback)(
    (variant = "horizontal") => createGeoAlertCardStyles(variant, positions),
    [positions]
  );
  const getInfoPanelStyles = (0, import_react3.useCallback)(
    () => createGeoAlertInfoPanelStyles(isMobile, positions),
    [isMobile, positions]
  );
  const updateConfig = (0, import_react3.useCallback)(
    (newConfig) => {
      updateGeoAlertLayoutVariables(newConfig);
    },
    []
  );
  const getCardContainerClass = (0, import_react3.useCallback)(
    (variant = "horizontal") => {

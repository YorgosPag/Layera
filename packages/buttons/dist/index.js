...
var Button = forwardRef(({
  ...
  const renderLoadingContent = () => {
    switch (loadingVariant) {
      case "dots":
        return /* @__PURE__ */ jsxs("div", { className: "layera-btn__dots", children: [
          /* @__PURE__ */ jsx("div", { className: "dot" }),
          /* @__PURE__ */ jsx("div", { className: "dot" }),
          /* @__PURE__ */ jsx("div", { className: "dot" })
        ] });
      case "pulse":
        return /* @__PURE__ */ jsx("div", { className: "layera-btn__pulse" });
      case "spinner":
      default:
        return /* @__PURE__ */ jsx("div", { className: "layera-btn__spinner" });
    }
  };
  const renderIcon = () => {
    if (!icon)
      return null;
    return /* @__PURE__ */ jsx("span", { className: "layera-btn__icon", children: icon });
  };
  const renderContent = () => {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      ...props,
      children: [
        loading && /* @__PURE__ */ jsx("div", { className: "layera-btn__loading", children: renderLoadingContent() }),
        /* @__PURE__ */ jsx("div", { className: "layera-btn__content", children: loading && loadingText ? loadingText : renderContent() })
      ]
    }
  );
});
...
export { Button, ButtonGroup, LinkButton, useButton };

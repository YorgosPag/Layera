...
import { LEGACY_LAYOUT_ALIASES, LEGACY_CONTAINER_ALIASES, LEGACY_VIEWPORT_ALIASES, CRYPTOGRAPHIC_CONSTANTS } from './legacy-aliases';
 ...
 */
export const cardPadding = `var(--la-space-4)`;
export const cardMargin = `var(--la-space-6)`;
export const buttonPadding = `var(--la-space-3) var(--la-space-4)`;

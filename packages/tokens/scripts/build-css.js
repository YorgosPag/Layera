...
/* ============================================= */
/*  PRIMARY SIDEBAR – ΣΥΜΒΑΤΟ ΜΕ @layera/* COMPONENTS */
/*  Χρησιμοποιεί ΜΟΝΟ τις υπάρχουσες --layera-* variables */
/* ============================================= */

.layera-sidebar-primary {
  width: var(--layera-sidebar-width);
  background-color: var(--layera-sidebar-bg);
  color: var(--layera-sidebar-text);
  padding: calc(var(--layera-space-8) + var(--layera-space-4)) var(--layera-space-4) var(--layera-space-4) var(--layera-space-4);
  flex-shrink: 0;
  order: 0;
  overflow-y: auto;
...
.layera-input--sidebar {
  width: calc(100% - var(--layera-space-2));
  max-width: 180px;

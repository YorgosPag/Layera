...
export const NAVIGATION_VARIABLES = {
  ...
  // NAVIGATION SEMANTIC BORDERS (από semantic/border)
  'navigation-border-default': BORDER_SEMANTIC_VARIABLES['border-subtle'],
  'navigation-border-active': BORDER_SEMANTIC_VARIABLES['border-interactive'],
  ...
  // NAVIGATION SPACING CONTEXTS (από core/spacing)
  'navigation-spacing-padding': SPACING_VARIABLES['spacing-4'],
  'navigation-spacing-margin': SPACING_VARIABLES['spacing-2'],
  'navigation-spacing-section': SPACING_VARIABLES['spacing-8'],

...
export const LOADING_VARIABLES = {
  ...
  'spinner-animation-duration': MOTION_VARIABLES['motion-duration-slow'],
  ...
  'skeleton-animation-duration': MOTION_VARIABLES['motion-duration-slow'],
  ...
  'dots-animation-duration': MOTION_VARIABLES['motion-duration-normal'],
  ...
  'pulse-opacity-end': '1',
  'pulse-duration': MOTION_VARIABLES['motion-duration-slow'],
  ...
  'wave-animation-duration': MOTION_VARIABLES['motion-duration-normal'],

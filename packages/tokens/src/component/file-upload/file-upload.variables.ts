...
export const FILE_UPLOAD_VARIABLES = {
  ...
  'upload-zone-transition': 'all var(--layera-motion-duration-normal) var(--layera-motion-easing-ease)',
...
export const PROGRESS_VARIABLES = {
  ...
  'progress-background': 'var(--layera-color-surface-muted)',
  ...
  // Progress animation
  'progress-animation': 'progressMove var(--layera-motion-duration-slow) ease-in-out infinite',
  'progress-transition': 'width var(--layera-motion-duration-fast) var(--layera-motion-easing-ease)',
...
export const DRAG_DROP_VARIABLES = {
  ...
  'drag-indicator-animation': 'dragPulse var(--layera-motion-duration-normal) ease-in-out infinite',

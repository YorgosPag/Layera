...
export { COLOR_VARIABLES, COLOR_VARIANTS, ColorComponentSystem } from './core/colors';

// Spacing - 8-point grid system
export * from './core/spacing';
export { SPACING_VARIABLES, SPACING_VARIANTS, SpacingComponentSystem } from './core/spacing';

// Typography - Font scales, weights, families
export * from './core/typography';
export { TYPOGRAPHY_VARIABLES, TYPOGRAPHY_VARIANTS, TypographyComponentSystem } from './core/typography';

// Borders - Border widths, radius, styles
export * from './core/borders';
export { BORDER_VARIABLES, BORDER_VARIANTS, BorderComponentSystem } from './core/borders';

// Shadows - Elevation system
export * from './core/shadows';
export { SHADOW_VARIABLES, SHADOW_VARIANTS, ShadowComponentSystem } from './core/shadows';

// Motion - Animation durations, easings
export * from './core/motion';
export { MOTION_VARIABLES, MOTION_VARIANTS, MotionComponentSystem } from './core/motion';

// Dimensions - Size scales, percentages
export * from './core/dimensions';
export { DIMENSION_VARIABLES, DIMENSION_VARIANTS, DimensionComponentSystem } from './core/dimensions';

// Utilities - Core utility tokens
export * from './core/utilities';
export { UTILITY_VARIABLES, UTILITY_VARIANTS, UtilityComponentSystem } from './core/utilities';

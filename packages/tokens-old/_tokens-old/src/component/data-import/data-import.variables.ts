...
export const DATA_IMPORT_VARIABLES = {
  ...
  'import-wizard-min-height': SPACING_VARIABLES['spacing-100'],
  ...
  'import-step-connector-width': BORDER_VARIABLES['border-width-2'],
  ...
  'import-file-selector-min-height': '12.5rem', // 200px - needs spacing token
  ...
  'import-preview-max-height': '18.75rem', // 300px - needs spacing token
  ...
  'import-mapping-connector-width': BORDER_VARIABLES['border-width-2'],
  ...
  'import-transition-duration': MOTION_VARIABLES['duration-normal'],
  'import-transition-easing': MOTION_VARIABLES['easing-ease-in-out'],
  'import-step-transition': `all ${MOTION_VARIABLES['duration-fast']} ${MOTION_VARIABLES['easing-ease-out']}`,
  ...
  'import-focus-outline-offset': SPACING_VARIABLES['spacing-0-5'],
  'import-aria-live': 'polite',
  'import-aria-busy': 'true',

  // IMPORT LOADING STATES
  'import-loading-opacity': '0.6',
  'import-loading-animation': `pulse ${MOTION_VARIABLES['duration-slow']} infinite`,
  'import-spinner-size': SPACING_VARIABLES['spacing-8'],
  'import-spinner-border-width': BORDER_VARIABLES['border-width-3'],
} as const;

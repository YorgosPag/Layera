...
var snapEngine = require('@layera/snap-engine');
var notifications = require('@layera/notifications');
var i18n = require('@layera/i18n');
var constants = require('@layera/constants');
var themeSwitcher = require('@layera/theme-switcher');
var icons = require('@layera/icons');
var jsxRuntime = require('react/jsx-runtime');
var cards = require('@layera/cards');
var buttons = require('@layera/buttons');
var forms = require('@layera/forms');
var typography = require('@layera/typography');
var layout = require('@layera/layout');
var viewport = require('@layera/viewport');
var errorBoundary = require('@layera/error-boundary');
var loading = require('@layera/loading');
...
function useSnapEngine2(options = {}) {
  ...
  react.useEffect(() => {
    try {
      const config = {
        tolerance: options.tolerance ?? constants.SNAP_CONSTANTS.DEFAULT_TOLERANCE,
        enabledTypes: options.enabledTypes ?? /* @__PURE__ */ new Set(["endpoint", "midpoint", "center"]),
        priority: constants.SNAP_CONSTANTS.DEFAULT_PRIORITIES,
        maxResults: constants.SNAP_CONSTANTS.MAX_RESULTS,
        performanceLevel: "medium",
        debugMode: options.debugMode ?? false
      };
      const engine = new snapEngine.SnapEngine(config);
  ...
  const snapToPoint = react.useCallback(async (cursor) => {
    if (!snapEngine$1) {
      return {
        target: null,
        snapped: false,
    ...
    try {
      ...
      const result = await snapEngine$1.snapToPoint(cursor);
      const metrics = snapEngine$1.getPerformanceMetrics();
  ...
  const addGeometry = react.useCallback((geometry) => {
    if (!snapEngine$1) return false;
    return snapEngine$1.addGeometry(geometry);
  }, [snapEngine$1]);
  const addGeometries = react.useCallback((geometries) => {
    if (!snapEngine$1) {
      return {
        searchTime: 0,
        indexTime: 0,
    ...
    setIsIndexing(true);
    const metrics = snapEngine$1.addGeometries(geometries);
    setPerformanceMetrics(metrics);
    return metrics;
  }, [snapEngine$1]);
  const removeGeometry = react.useCallback((id) => {
    if (!snapEngine$1) return false;
    return snapEngine$1.removeGeometry(id);
  }, [snapEngine$1]);
  const clearGeometries = react.useCallback(() => {
    if (!snapEngine$1) return;
    snapEngine$1.clearGeometries();
    setLastSnapResult(null);
  ...
  const updateConfig = react.useCallback((config) => {
    if (!snapEngine$1) return;
    snapEngine$1.updateConfiguration(config);
  }, [snapEngine$1]);
  const setEnabled = react.useCallback((enabled) => {
    setIsEnabledState(enabled);
    if (snapEngine$1) {
      snapEngine$1.setEnabled(enabled);
    }
    if (!enabled) {
      setLastSnapResult(null);
    }
  }, [snapEngine$1]);
  const setTolerance = react.useCallback((tolerance) => {
    if (!snapEngine$1) return;
    snapEngine$1.setTolerance(tolerance);
  }, [snapEngine$1]);
  const rebuildIndex = react.useCallback(() => {
    ...
    setIsIndexing(true);
    const metrics = snapEngine$1.rebuildIndex();
    setPerformanceMetrics(metrics);
    setIsIndexing(false);
    return metrics;
  }, [snapEngine$1]);
  const isSnapped = react.useMemo(() => {
    return lastSnapResult?.snapped ?? false;
  }, [lastSnapResult]);
  return {
    // Core functionality
    snapEngine: snapEngine$1,
    snapToPoint,
    // State
    isEnabled,
    lastSnapResult,
...
var SnapIndicator = ({
  ...
  const tooltipContent = showTooltip ? /* @__PURE__ */ jsxRuntime.jsxs("div", { style: tooltipStyle, children: [
    t(`snap.types.${snapType}`, { defaultValue: snapType }),
    target.metadata?.layer && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { fontSize: "10px", opacity: 0.8 }, children: [
      t("snap.layer"),
      ": ",
      target.metadata.layer
    ] })
  ] }) : null;
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: indicatorStyle, className, children: [
...
var SnapCursor = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { style: cursorStyle });
};
var SnapGuidelines = ({
  snapResult,
  cursorPosition,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    showDistance && distance > 5 && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: distanceLabelStyle, children: [
      distance,
      "px"
    ] })
  ] });
...
var SnapSettingsPanel = ({
  ...
  const handleSnapTypeToggle = react.useCallback((type, enabled) => {
  ...
  const handlePerformanceLevelChange = react.useCallback((level) => {
  ...
  const renderSnapTypeToggle = (type) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      forms.FormField,
      {
        label: /* @__PURE__ */ jsxRuntime.jsxs(layout.Stack, { direction: "row", spacing: 8, align: "center", children: [
          /* @__PURE__ */ jsxRuntime.jsx(icons.Icon, { name: info.icon, size: 16 }),
          /* @__PURE__ */ jsxRuntime.jsx(typography.Text, { variant: "body2", weight: "medium", children: t(`snap.types.${type}`) })
        ] }),
  ...
  const renderCategorySection = (category) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      forms.FormSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(layout.Stack, { spacing: compact ? 8 : 12, children: types.map(renderSnapTypeToggle) })
      }
    );
  };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(layout.Stack, { direction: "row", spacing: 8, align: "center", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      buttons.ToggleButton,
      {
        ...
        variant: "primary",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(icons.Icon, { name: "magnet", size: 16, style: { marginRight: 4 } }),
          t("snap.toolbar.snap")
        ]
      }
    ),
    enabled && quickTypes.map((type) => /* @__PURE__ */ jsxRuntime.jsx(
      buttons.ToggleButton,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(icons.Icon, { name: SNAP_TYPE_INFO[type].icon, size: 14 })
      },
      type
    )),
    onOpenSettings && /* @__PURE__ */ jsxRuntime.jsx(
      buttons.Button,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(icons.Icon, { name: "settings", size: 16 })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(layout.Stack, { direction: "row", spacing: 4, align: "center", children: /* @__PURE__ */ jsxRuntime.jsxs(typography.Text, { variant: "caption", color: "muted", children: [
...
var SnapCanvas = ({
  ...
  const renderGeometries = react.useCallback((ctx) => {
  ...
  const renderGeometry = react.useCallback((ctx, geometry) => {
  ...
  const handleMouseMove = react.useCallback(async (e) => {
  ...
  const handleMouseClick = react.useCallback((e) => {
  ...
  const findGeometryAtPoint = react.useCallback((point) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(errorBoundary.ErrorBoundary, { children: /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ref: containerRef,
      ...
      children: [
        ...
        isIndexing && /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
          position: "absolute",
          top: 0,
          left: 0,
          right: 0,
          ...
          justifyContent: "center",
          zIndex: 1e3
        }, children: /* @__PURE__ */ jsxRuntime.jsx(loading.LoadingSpinner, { size: "large" }) }),
        snapEnabled && canvasState.lastSnapResult && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          showSnapIndicators && /* @__PURE__ */ jsxRuntime.jsx(
            SnapIndicator,
            {
          ...
          showSnapGuidelines && /* @__PURE__ */ jsxRuntime.jsx(
            SnapGuidelines,
            {
              snapResult: canvasState.lastSnapResult,
        ...
        showSnapCursor && interactive && /* @__PURE__ */ jsxRuntime.jsx(
          SnapCursor,
          {
            snapResult: canvasState.lastSnapResult || {
              target: null,
...
var CADSnapCanvas = (props) => /* @__PURE__ */ jsxRuntime.jsx(SnapCanvas, { ...props, tolerance: 5, showSnapGuidelines: true });
var GISSnapCanvas = (props) => /* @__PURE__ */ jsxRuntime.jsx(SnapCanvas, { ...props, tolerance: 15, showSnapGuidelines: false });
var MobileSnapCanvas = (props) => /* @__PURE__ */ jsxRuntime.jsx(SnapCanvas, { ...props, tolerance: 25, showSnapGuidelines: false });
...
exports.CADSnapCanvas = CADSnapCanvas;
exports.GISSnapCanvas = GISSnapCanvas;
exports.MobileSnapCanvas = MobileSnapCanvas;
exports.SNAP_INTERACTION_DEFAULTS = SNAP_INTERACTION_DEFAULTS;
exports.SnapCanvas = SnapCanvas;
exports.SnapCursor = SnapCursor;
exports.SnapGuidelines = SnapGuidelines;
exports.SnapIndicator = SnapIndicator;
exports.SnapPerformanceUtils = SnapPerformanceUtils;
exports.SnapSettingsPanel = SnapSettingsPanel;
exports.SnapToolbar = SnapToolbar;
exports.VERSION = VERSION;
exports.createSnapCanvas = createSnapCanvas;
exports.useCADSnap = useCADSnap;
exports.useGISSnap = useGISSnap;
exports.useMobileSnap = useMobileSnap;
exports.useSnapEngine = useSnapEngine2;
exports.validateSnapProps = validateSnapProps;
exports.withSnapSupport = withSnapSupport;

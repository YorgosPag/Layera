...
var SnapSettingsPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Card, { className: compact ? "snap-settings-compact" : "snap-settings-full", children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(Stack, { direction: "row", justify: "space-between", align: "center", children: [
      /* @__PURE__ */ jsxs(Stack, { direction: "row", spacing: 8, align: "center", children: [
    ...
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs(Stack, { spacing: compact ? 16 : 24, children: [

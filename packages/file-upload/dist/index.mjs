...
import { UploadIcon as UploadIcon4, DeleteIcon as DeleteIcon2 } from "@layera/icons";
...
var DragDropZone = ({
  ...
  return /* @__PURE__ */ jsx(Card, { className: `${getZoneClasses()} ${className}`, children: /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center space-y-4", children: [
          /* @__PURE__ */ jsx("div", { className: `p-4 rounded-full ${isDragOver ? "bg-blue-100 text-blue-600" : theme === "dark" ? "bg-gray-700 text-gray-300" : "bg-gray-100 text-gray-500"}`, children: /* @__PURE__ */ jsx(UploadIcon, { className: "w-8 h-8" }) }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Typography, { size: "lg", weight: "medium", className: "", children: dropZoneText || (isDragOver ? t("file-upload.drop-files-here") : t("file-upload.drag-files-or-click")) }),
            /* @__PURE__ */ jsxs(Typography, { size: "sm", className: theme === "dark" ? "text-gray-400" : "text-gray-500", children: [
              acceptedTypes.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
                t("file-upload.accepted-types"),
                ": ",
                acceptedTypes.join(", "),
                /* @__PURE__ */ jsx("br", {})
              ] }),
              maxFiles && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          isDragOver && /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2 text-blue-600", children: [
            /* @__PURE__ */ jsx(UploadIcon, { className: "w-5 h-5" }),
            /* @__PURE__ */ jsx(Typography, { size: "base", weight: "medium", className: "", children: t("file-upload.release-to-upload") })
          ] })
        ] })
      ]
    }
...
import { UploadIcon as UploadIcon2, CloseIcon, RefreshIcon, DeleteIcon } from "@layera/icons";
...
var FileList = ({
  ...
  if (files.length === 0) {
    return /* @__PURE__ */ jsxs2(Card2, { className: `p-6 text-center ${theme === "dark" ? "bg-gray-800" : "bg-gray-50"}`, children: [
      /* @__PURE__ */ jsx2(UploadIcon2, { className: "w-12 h-12 mx-auto mb-4 text-gray-400" }),
      /* @__PURE__ */ jsx2(Typography2, { size: "base", className: "text-gray-500", children: t("file-upload.no-files") })
    ] });
  }
  return /* @__PURE__ */ jsx2("div", { className: "space-y-3", children: files.map((file) => /* @__PURE__ */ jsx2(
    FileListItem,
    {
      file,
      showProgress,
...
var FileListItem = ({
  ...
  const getStatusIcon = () => {
    switch (file.status) {
      case "completed":
        return /* @__PURE__ */ jsx2(UploadIcon2, { className: "w-5 h-5 text-green-500" });
      case "error":
        return /* @__PURE__ */ jsx2(CloseIcon, { className: "w-5 h-5 text-red-500" });
      case "uploading":
        return /* @__PURE__ */ jsx2(UploadIcon2, { className: "w-5 h-5 text-blue-500 animate-pulse" });
      case "cancelled":
        return /* @__PURE__ */ jsx2(CloseIcon, { className: "w-5 h-5 text-gray-500" });
      case "paused":
        return /* @__PURE__ */ jsx2(UploadIcon2, { className: "w-5 h-5 text-yellow-500" });
      default:
        return /* @__PURE__ */ jsx2(UploadIcon2, { className: "w-5 h-5 text-gray-400" });
    }
  };
  const getStatusText = () => {
    switch (file.status) {
  ...
  return /* @__PURE__ */ jsx2(Card2, { className: `p-4 ${theme === "dark" ? "bg-gray-800" : "bg-white"}`, children: /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center space-x-3 flex-1 min-w-0", children: [
      /* @__PURE__ */ jsx2("div", { className: "flex-shrink-0", children: getStatusIcon() }),
      /* @__PURE__ */ jsxs2("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsx2(Typography2, { size: "base", weight: "medium", className: "truncate", children: file.file.name }),
          /* @__PURE__ */ jsx2(Typography2, { size: "sm", className: "text-gray-500 ml-2", children: formatBytes(file.file.size) })
        ] }),
        /* @__PURE__ */ jsxs2("div", { className: "flex items-center space-x-4 mt-1", children: [
          /* @__PURE__ */ jsx2(Typography2, { size: "sm", className: "text-gray-500", children: getStatusText() }),
          file.status === "uploading" && file.speed && /* @__PURE__ */ jsxs2(Fragment2, { children: [
            /* @__PURE__ */ jsx2(Typography2, { size: "sm", className: "text-gray-500", children: formatUploadSpeed(file.speed) }),
            file.eta && /* @__PURE__ */ jsx2(Typography2, { size: "sm", className: "text-gray-500", children: t("file-upload.eta", { time: formatETA(file.eta) }) })
          ] })
        ] }),
        showProgress && /* @__PURE__ */ jsx2("div", { className: `w-full bg-gray-200 rounded-full h-2 mt-2 ${theme === "dark" ? "bg-gray-600" : "bg-gray-200"}`, children: /* @__PURE__ */ jsx2(
          "div",
          {
    ...
    showActions && /* @__PURE__ */ jsxs2("div", { className: "flex items-center space-x-2 ml-4", children: [
      file.status === "uploading" && /* @__PURE__ */ jsx2(
        Button,
        {
          variant: "outline",
          size: "sm",
          ...
          children: /* @__PURE__ */ jsx2(CloseIcon, { className: "w-4 h-4" })
        }
      ),
      file.status === "error" && /* @__PURE__ */ jsx2(
        Button,
        {
          variant: "outline",
          size: "sm",
          ...
          children: /* @__PURE__ */ jsx2(RefreshIcon, { className: "w-4 h-4" })
        }
      ),
      (file.status === "completed" || file.status === "error" || file.status === "cancelled") && /* @__PURE__ */ jsx2(
        Button,
        {
          variant: "outline",
          size: "sm",
          ...
          children: /* @__PURE__ */ jsx2(DeleteIcon, { className: "w-4 h-4" })
        }
      )
    ] })
  ] }) });
...
import { UploadIcon as UploadIcon3, CloseIcon as CloseIcon2 } from "@layera/icons";
import { useTheme as useTheme3 } from "@layera/theme-switcher";
...
var FilePreview = ({
  ...
  const getFileIcon = () => {
    return /* @__PURE__ */ jsx3(UploadIcon3, { className: "w-8 h-8" });
  };
  ...
  const getProgressOverlay = () => {
    ...
    return /* @__PURE__ */ jsx3("div", { className: "absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center", children: /* @__PURE__ */ jsxs3("div", { className: "text-center text-white", children: [
      /* @__PURE__ */ jsx3(UploadIcon3, { className: "w-6 h-6 mx-auto mb-2 animate-pulse" }),
      /* @__PURE__ */ jsxs3(Typography3, { variant: "caption", className: "text-white", children: [
  ...
  return /* @__PURE__ */ jsx3(Card3, { className: `relative overflow-hidden transition-all duration-200 ${getStatusColor()} border-2 ${onClick ? "cursor-pointer hover:shadow-lg" : ""}`, children: /* @__PURE__ */ jsxs3("div", { onClick: handleClick, className: "relative", children: [
    /* @__PURE__ */ jsxs3("div", { className: "aspect-square bg-gray-50 dark:bg-gray-800 flex items-center justify-center", children: [
      showPreview && previewUrl && !previewError ? /* @__PURE__ */ jsx3(
        "img",
        {
          src: previewUrl,
          alt: file.file.name,
      ...
      ) : /* @__PURE__ */ jsx3("div", { className: `text-gray-400 ${theme === "dark" ? "text-gray-500" : "text-gray-400"}`, children: getFileIcon() }),
      getProgressOverlay(),
      /* @__PURE__ */ jsxs3("div", { className: "absolute top-2 left-2", children: [
        file.status === "completed" && /* @__PURE__ */ jsx3("div", { className: "bg-green-500 text-white rounded-full p-1", children: /* @__PURE__ */ jsx3(UploadIcon3, { className: "w-3 h-3" }) }),
        file.status === "error" && /* @__PURE__ */ jsx3("div", { className: "bg-red-500 text-white rounded-full p-1", children: /* @__PURE__ */ jsx3(CloseIcon2, { className: "w-3 h-3" }) }),
        file.status === "uploading" && /* @__PURE__ */ jsx3("div", { className: "bg-blue-500 text-white rounded-full p-1", children: /* @__PURE__ */ jsx3(UploadIcon3, { className: "w-3 h-3 animate-pulse" }) })
      ] }),
      /* @__PURE__ */ jsx3("div", { className: "absolute top-2 right-2", children: /* @__PURE__ */ jsx3(
        Button2,
        {
          variant: "outline",
          size: "sm",
          ...
          children: /* @__PURE__ */ jsx3(CloseIcon2, { className: "w-3 h-3" })
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxs3("div", { className: "p-3", children: [
      ...
      /* @__PURE__ */ jsxs3("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx3(Typography3, { variant: "caption", className: "text-gray-500", children: formatBytes(file.file.size) }),
        file.status === "uploading" && /* @__PURE__ */ jsxs3(Typography3, { variant: "caption", className: "text-blue-600", children: [
          Math.round(file.progress),
          "%"
        ] }),
        file.status === "error" && /* @__PURE__ */ jsx3(Typography3, { variant: "caption", className: "text-red-600", title: file.error, children: t("file-upload.status.error") })
      ] }),
      /* @__PURE__ */ jsx3("div", { className: "mt-2", children: /* @__PURE__ */ jsx3("span", { className: `inline-block px-2 py-1 text-xs rounded ${theme === "dark" ? "bg-gray-700 text-gray-300" : "bg-gray-100 text-gray-600"}`, children: file.file.type || t("file-upload.unknown-type") }) }),
      file.status === "uploading" && file.speed && /* @__PURE__ */ jsx3("div", { className: "mt-2 space-y-1", children: /* @__PURE__ */ jsxs3("div", { className: "flex items-center justify-between text-xs text-gray-500", children: [
        /* @__PURE__ */ jsxs3("span", { children: [
          formatBytes(file.speed),
          "/s"
        ] }),
        file.eta && /* @__PURE__ */ jsx3("span", { children: Math.floor(file.eta / 60) > 0 ? `${Math.floor(file.eta / 60)}:${Math.floor(file.eta % 60).toString().padStart(2, "0")}` : `${Math.floor(file.eta)}s` })
      ] }) })
    ] })
  ] }) });
};
...
var FileUploader = ({
  ...
  const handleFilesAdded = useCallback2((newFiles) => {
    if (disabled) return;
  ...
  const handleStartUpload = useCallback2(() => {
  ...
  const handlePauseUpload = useCallback2(() => {
  ...
  const handleCancelUpload = useCallback2((fileId) => {
    uploadEngineRef.current?.cancelUpload(fileId);
  }, []);
  const handleRetryUpload = useCallback2((fileId) => {
  ...
  const handleRemoveFile = useCallback2((fileId) => {
    const file = files.find((f) => f.id === fileId);
    if (!file) return;
  ...
  return /* @__PURE__ */ jsx4(ErrorBoundary, { children: /* @__PURE__ */ jsxs4("div", { className: `layera-file-uploader ${className}`, children: [
    hasFiles && /* @__PURE__ */ jsxs4("div", { className: `mb-6 p-4 rounded-lg ${theme === "dark" ? "bg-gray-800" : "bg-gray-50"}`, children: [
      /* @__PURE__ */ jsxs4("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxs4("div", { children: [
          /* @__PURE__ */ jsx4(Typography4, { variant: "h6", className: "mb-1", children: t("file-upload.upload-summary") }),
          /* @__PURE__ */ jsx4(Typography4, { variant: "caption", className: "text-gray-500", children: t("file-upload.files-summary", {
            total: summary.total,
        ...
        /* @__PURE__ */ jsxs4("div", { className: "flex items-center space-x-2", children: [
          /* @__PURE__ */ jsxs4("div", { className: "flex items-center space-x-1 mr-4", children: [
            /* @__PURE__ */ jsx4(
              Button3,
              {
                ...
                children: /* @__PURE__ */ jsx4(UploadIcon4, { className: "w-4 h-4" })
              }
            ),
            /* @__PURE__ */ jsx4(
              Button3,
          ...
          canStartUpload && /* @__PURE__ */ jsxs4(
            Button3,
            {
              ...
              disabled,
              children: [
                /* @__PURE__ */ jsx4(UploadIcon4, { className: "w-4 h-4 mr-2" }),
                t("file-upload.start-upload")
              ]
            }
          ),
          isUploading && /* @__PURE__ */ jsxs4(
            Button3,
            {
              variant: "outline",
          ...
          /* @__PURE__ */ jsxs4(
            Button3,
            {
              ...
              children: [
                /* @__PURE__ */ jsx4(DeleteIcon2, { className: "w-4 h-4 mr-2" }),
      ...
      isUploading && summary.total > 0 && /* @__PURE__ */ jsx4("div", { className: "w-full bg-gray-200 rounded-full h-2", children: /* @__PURE__ */ jsx4(
        "div",
        {
    ...
    hasFiles && /* @__PURE__ */ jsx4("div", { className: "mb-6", children: viewMode === "list" ? /* @__PURE__ */ jsx4(
      FileListComponent,
      {
        files,
        showProgress: true,
    ...
    ) : /* @__PURE__ */ jsx4("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4", children: files.map((file) => /* @__PURE__ */ jsx4(
      FilePreview,
      {
        file,
        showPreview: true,

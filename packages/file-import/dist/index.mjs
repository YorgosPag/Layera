...
import React4, { useState as useState4, useCallback as useCallback5 } from "react";
import { BaseCard } from "@layera/cards";
import { Button as Button3 } from "@layera/buttons";
import { LoadingSpinner as LoadingSpinner3 } from "@layera/loading";
...
var Heading = ({
  ...
  return /* @__PURE__ */ jsx2(Component, { className: classes, ...props, children });
};
...
function useFileImport(options = {}) {
  ...
  const reportProgress = useCallback((fileId, progress2, stage, message) => {
    const progressData = {
      fileId,
      stage,
      progress: progress2,
  ...
  const importSingleFile = useCallback(async (file) => {
...
import { useLayeraTranslation as useLayeraTranslation2 } from "@layera/i18n/hooks";
...
var DragDropZone = ({
  ...
  const validateDroppedFiles = useCallback2((files) => {
  ...
  const formatAcceptedTypes = useCallback2(() => {
    return acceptedFormats.map((format) => `.${format}`).join(", ");
  }, [acceptedFormats]);
  const getDropZoneClasses = useCallback2(() => {
    const baseClasses = [
      "file-drop-zone",
      "transition-all",
      "duration-200",
  ...
  return /* @__PURE__ */ jsx3(Card, { className: `file-drop-zone-card ${className}`, children: /* @__PURE__ */ jsx3(CardContent, { children: /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        children,
        showHelper && !children && /* @__PURE__ */ jsxs("div", { className: "drag-drop-helper", children: [
          /* @__PURE__ */ jsx3("div", { className: "upload-icon", style: { marginBottom: "16px" }, children: /* @__PURE__ */ jsxs(
            "svg",
            {
              width: "48",
              height: "48",
          ...
          /* @__PURE__ */ jsx3(Text, { variant: "body", weight: "medium", color: disabled ? "disabled" : "primary", children: dragState.isOver ? dragState.canDrop ? t("file.drop.zone.drop.here") : t("file.drop.zone.invalid.files") : t("file.drop.zone.instruction") }),
          /* @__PURE__ */ jsx3(Text, { variant: "caption", color: "secondary", style: { marginTop: "8px" }, children: t("file.drop.zone.accepted.formats", {
...
import { Card as Card2, CardContent as CardContent2 } from "@layera/cards";
import { Button, IconButton } from "@layera/buttons";
import { ProgressBar, LoadingSpinner } from "@layera/loading";
import { useLayeraTranslation as useLayeraTranslation3 } from "@layera/i18n/hooks";
...
var FileList = ({
  ...
  const formatFileSize2 = useCallback3((bytes) => {
    const units = ["B", "KB", "MB", "GB"];
    let size = bytes;
    let unitIndex = 0;
    while (size >= 1024 && unitIndex < units.length - 1) {
  ...
  const getFileIcon = useCallback3((file) => {
  ...
  const getStatusColor = useCallback3((status) => {
    switch (status) {
      case "completed":
        return "green";
      case "error":
  ...
  const getStatusText = useCallback3((file) => {
    switch (file.status) {
      case "completed":
  ...
  const renderFileThumbnail = useCallback3((file) => {
  ...
  const renderFileActions = useCallback3((file) => {
    return /* @__PURE__ */ jsxs2("div", { style: { display: "flex", gap: "8px", alignItems: "center" }, children: [
      file.status === "error" && /* @__PURE__ */ jsx4(
        Button,
        {
          variant: "secondary",
          size: "small",
      ...
      file.status === "completed" && /* @__PURE__ */ jsx4(
        Button,
        {
          variant: "primary",
          size: "small",
  ...
  const renderFileItem = useCallback3((file) => {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs2("div", { style: { flex: 1, minWidth: 0 }, children: [
              /* @__PURE__ */ jsx4(Text, { variant: "body", weight: "medium", style: {
                overflow: "hidden",
                textOverflow: "ellipsis",
                whiteSpace: "nowrap"
              }, children: file.metadata.name }),
              /* @__PURE__ */ jsx4(Text, { variant: "caption", color: "secondary", children: formatFileSize2(file.metadata.size) })
            ] }),
            file.status === "processing" && /* @__PURE__ */ jsx4(LoadingSpinner, { size: "small" }),
            /* @__PURE__ */ jsx4(
              IconButton,
              {
                variant: "secondary",
    ...
    return /* @__PURE__ */ jsx4(
      Card2,
      {
        ...
        onClick: () => !disabled && onFileSelect(file),
        children: /* @__PURE__ */ jsx4(CardContent2, { style: { padding: "16px" }, children: /* @__PURE__ */ jsxs2("div", { style: { display: "flex", alignItems: "flex-start", gap: "16px" }, children: [
          renderFileThumbnail(file),
          /* @__PURE__ */ jsxs2("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ jsxs2("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }, children: [
              /* @__PURE__ */ jsxs2("div", { style: { flex: 1, minWidth: 0 }, children: [
                ...
                /* @__PURE__ */ jsxs2(Text, { variant: "caption", color: "secondary", children: [
            ...
            /* @__PURE__ */ jsxs2("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
              /* @__PURE__ */ jsxs2("div", { style: { flex: 1 }, children: [
                /* @__PURE__ */ jsxs2("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }, children: [
                  /* @__PURE__ */ jsx4(
                    Text,
                    {
                      variant: "caption",
                  ...
                  file.status === "processing" && /* @__PURE__ */ jsxs2(Text, { variant: "caption", color: "secondary", children: [
                    file.progress,
                    "%"
                  ] })
                ] }),
                file.status === "processing" && /* @__PURE__ */ jsx4(
                  ProgressBar,
                  {
                    value: file.progress,
                    size: "small",
            ...
            file.metadata.dimensions && /* @__PURE__ */ jsx4(Text, { variant: "caption", color: "secondary", style: { marginTop: "8px" }, children: t("file.dimensions", {
  ...
  return /* @__PURE__ */ jsx4("div", { className: "file-list", style: { display: "flex", flexDirection: "column", gap: compact ? "8px" : "12px" }, children: files.map(renderFileItem) });
};

// src/components/FilePreview.tsx
import { useState as useState3, useCallback as useCallback4, useMemo as useMemo2 } from "react";
import { Card as Card3, CardContent as CardContent3, CardHeader } from "@layera/cards";
import { Button as Button2, IconButton as IconButton2 } from "@layera/buttons";
import { LoadingSpinner as LoadingSpinner2 } from "@layera/loading";
import { useLayeraTranslation as useLayeraTranslation4 } from "@layera/i18n/hooks";
...
var FilePreview = ({
  ...
  const [previewError, setPreviewError] = useState3(null);
  const fileExtension = useMemo2(() => {
    return file.file.name.split(".").pop()?.toLowerCase();
  }, [file.file.name]);
  const fileCategory = useMemo2(() => {
  ...
  const formatFileSize2 = useCallback4((bytes) => {
    const units = ["B", "KB", "MB", "GB"];
    let size = bytes;
    let unitIndex = 0;
    while (size >= 1024 && unitIndex < units.length - 1) {
  ...
  const formatDate = useCallback4((timestamp) => {
  ...
  const renderImagePreview = useCallback4(() => {
    if (!file.previewUrl) {
      return /* @__PURE__ */ jsx5("div", { style: {
        ...
        borderRadius: "8px",
        border: "1px solid #e0e0e0"
      }, children: /* @__PURE__ */ jsx5(Text, { color: "secondary", children: t("file.preview.no.image") }) });
    }
    return /* @__PURE__ */ jsxs3("div", { style: {
      ...
      file.metadata.dimensions && /* @__PURE__ */ jsx5(Text, { variant: "caption", color: "secondary", style: { marginTop: "8px", display: "block" }, children: t("file.dimensions", {
        width: file.metadata.dimensions.width,
        height: file.metadata.dimensions.height
      }) })
    ] });
  }, [file.previewUrl, file.metadata, t]);
  const renderDocumentPreview = useCallback4(() => {
    return /* @__PURE__ */ jsxs3("div", { style: {
      height: "300px",
      backgroundColor: "#f5f5f5",
      display: "flex",
      ...
      /* @__PURE__ */ jsx5("div", { style: { fontSize: "48px" }, children: "\u{1F4C4}" }),
      /* @__PURE__ */ jsx5(Text, { variant: "body", weight: "medium", children: t("file.preview.document.title") }),
      /* @__PURE__ */ jsx5(Text, { variant: "caption", color: "secondary", style: { textAlign: "center" }, children: t("file.preview.document.description") }),
      /* @__PURE__ */ jsx5(Button2, { variant: "primary", onClick: handleDownload, children: t("file.action.download") })
    ] });
  }, [handleDownload, t]);
  const renderCADPreview = useCallback4(() => {
    return /* @__PURE__ */ jsxs3("div", { style: {
      height: "300px",
      backgroundColor: "#f5f5f5",
      display: "flex",
      ...
      /* @__PURE__ */ jsx5("div", { style: { fontSize: "48px" }, children: "\u{1F4D0}" }),
      /* @__PURE__ */ jsx5(Text, { variant: "body", weight: "medium", children: t("file.preview.cad.title") }),
      /* @__PURE__ */ jsx5(Text, { variant: "caption", color: "secondary", style: { textAlign: "center", maxWidth: "300px" }, children: fileExtension?.toUpperCase() === "DXF" ? t("file.preview.cad.dxf.description") : t("file.preview.cad.dwg.description") }),
      /* @__PURE__ */ jsxs3("div", { style: { display: "flex", gap: "8px" }, children: [
        /* @__PURE__ */ jsx5(Button2, { variant: "primary", onClick: handleDownload, children: t("file.action.download") }),
        /* @__PURE__ */ jsxs3(Button2, { variant: "secondary", disabled: true, children: [
  ...
  const renderVectorPreview = useCallback4(() => {
    return /* @__PURE__ */ jsxs3("div", { style: {
      height: "300px",
      backgroundColor: "#f5f5f5",
      display: "flex",
      ...
      /* @__PURE__ */ jsx5("div", { style: { fontSize: "48px" }, children: "\u{1F3A8}" }),
      /* @__PURE__ */ jsx5(Text, { variant: "body", weight: "medium", children: t("file.preview.vector.title") }),
      /* @__PURE__ */ jsx5(Text, { variant: "caption", color: "secondary", style: { textAlign: "center" }, children: t("file.preview.vector.description") }),
      /* @__PURE__ */ jsx5(Button2, { variant: "primary", onClick: handleDownload, children: t("file.action.download") })
    ] });
  }, [handleDownload, t]);
  const renderPreviewContent = useCallback4(() => {
    if (file.status === "processing") {
      return /* @__PURE__ */ jsxs3("div", { style: {
        ...
        /* @__PURE__ */ jsx5(LoadingSpinner2, { size: "large" }),
        /* @__PURE__ */ jsx5(Text, { variant: "body", color: "secondary", children: t("file.preview.processing") }),
        /* @__PURE__ */ jsxs3(Text, { variant: "caption", color: "secondary", children: [
          file.progress,
          "% ",
          t("common.completed")
        ] })
    ...
    if (file.status === "error") {
      return /* @__PURE__ */ jsxs3("div", { style: {
        ...
        /* @__PURE__ */ jsx5("div", { style: { fontSize: "48px", color: "#f44336" }, children: "\u26A0\uFE0F" }),
        /* @__PURE__ */ jsx5(Text, { variant: "body", color: "error", weight: "medium", children: t("file.preview.error.title") }),
        /* @__PURE__ */ jsx5(Text, { variant: "caption", color: "secondary", style: { textAlign: "center" }, children: file.error || t("file.preview.error.description") })
      ] });
    }
    if (previewError) {
      return /* @__PURE__ */ jsxs3("div", { style: {
        ...
        /* @__PURE__ */ jsx5("div", { style: { fontSize: "48px", color: "#f44336" }, children: "\u26A0\uFE0F" }),
        /* @__PURE__ */ jsx5(Text, { variant: "body", color: "error", weight: "medium", children: t("file.preview.error.title") }),
        /* @__PURE__ */ jsx5(Text, { variant: "caption", color: "secondary", children: previewError })
      ] });
    }
    switch (fileCategory) {
      case "image":
      ...
      default:
        return /* @__PURE__ */ jsxs3("div", { style: {
          ...
          /* @__PURE__ */ jsx5("div", { style: { fontSize: "48px" }, children: "\u{1F4CE}" }),
          /* @__PURE__ */ jsx5(Text, { variant: "body", weight: "medium", children: t("file.preview.unsupported.title") }),
          /* @__PURE__ */ jsx5(Text, { variant: "caption", color: "secondary", children: t("file.preview.unsupported.description") }),
          /* @__PURE__ */ jsx5(Button2, { variant: "primary", onClick: handleDownload, children: t("file.action.download") })
        ] });
    }
  }, [
  ...
  return /* @__PURE__ */ jsxs3(Card3, { className: "file-preview", style: { maxHeight, overflow: "auto" }, children: [
    /* @__PURE__ */ jsx5(CardHeader, { children: /* @__PURE__ */ jsxs3("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" }, children: [
      /* @__PURE__ */ jsxs3("div", { style: { flex: 1, minWidth: 0 }, children: [
        /* @__PURE__ */ jsx5(Heading, { level: 4, style: {
          overflow: "hidden",
          textOverflow: "ellipsis",
          whiteSpace: "nowrap",
          marginBottom: "4px"
    ...
    /* @__PURE__ */ jsxs3(CardContent3, { children: [
      ...
      showMetadata && file.status === "completed" && /* @__PURE__ */ jsxs3("div", { style: { marginTop: "24px" }, children: [
        /* @__PURE__ */ jsx5(Heading, { level: 5, style: { marginBottom: "12px" }, children: t("file.metadata.title") }),
        /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gridTemplateColumns: "auto 1fr", gap: "8px 16px", fontSize: "14px" }, children: [
          /* @__PURE__ */ jsxs3(Text, { variant: "caption", color: "secondary", weight: "medium", children: [
            t("file.metadata.name"),
            ":"
          ] }),
          /* @__PURE__ */ jsx5(Text, { variant: "caption", children: file.metadata.name }),
          /* @__PURE__ */ jsxs3(Text, { variant: "caption", color: "secondary", weight: "medium", children: [
            t("file.metadata.size"),
            ":"
          ] }),
          /* @__PURE__ */ jsx5(Text, { variant: "caption", children: formatFileSize2(file.metadata.size) }),
          /* @__PURE__ */ jsxs3(Text, { variant: "caption", color: "secondary", weight: "medium", children: [
            t("file.metadata.type"),
            ":"
          ] }),
          /* @__PURE__ */ jsx5(Text, { variant: "caption", children: file.metadata.type }),
          /* @__PURE__ */ jsxs3(Text, { variant: "caption", color: "secondary", weight: "medium", children: [
            t("file.metadata.modified"),
            ":"
          ] }),
          /* @__PURE__ */ jsx5(Text, { variant: "caption", children: formatDate(file.metadata.lastModified) }),
          file.metadata.dimensions && /* @__PURE__ */ jsxs3(Fragment, { children: [
            /* @__PURE__ */ jsxs3(Text, { variant: "caption", color: "secondary", weight: "medium", children: [
              t("file.metadata.dimensions"),
              ":"
            ] }),
            /* @__PURE__ */ jsxs3(Text, { variant: "caption", children: [
      ...
      showActions && file.status === "completed" && /* @__PURE__ */ jsxs3("div", { style: { marginTop: "24px", display: "flex", gap: "12px", justifyContent: "flex-end" }, children: [
        /* @__PURE__ */ jsx5(Button2, { variant: "secondary", onClick: handleDownload, children: t("file.action.download") }),
        /* @__PURE__ */ jsx5(Button2, { variant: "primary", onClick: onClose, children: t("common.close") })
      ] })
    ] })
  ] });
};
...
var SafeErrorBoundary = ({ children, fallback }) => {
  return React4.createElement(ErrorBoundary, { fallback }, children);
};
var SafeLoadingSpinner = (props) => {
  return React4.createElement(LoadingSpinner3, props);
};
var FileImporter = ({
  onFileImported,
  acceptedFormats,
  ...
  const handleFilesDrop = useCallback5(async (droppedFiles) => {
    if (disabled) return;
    try {
  ...
  const handleFileInputChange = useCallback5((event) => {
  ...
  const handleFileSelect = useCallback5((file) => {
    setSelectedFile(file);
  }, []);
  const handleFileRemove = useCallback5((fileId) => {
    removeFile(fileId);
    if (selectedFile?.id === fileId) {
      setSelectedFile(null);
    }
  }, [removeFile, selectedFile]);
  const formatFileTypes = useCallback5(() => {
    return acceptedFormats.map((format) => `.${format}`).join(", ");
  }, [acceptedFormats]);
  const formatMaxSize = useCallback5(() => {
    const mb = maxFileSize / (1024 * 1024);
    return mb >= 1 ? `${Math.round(mb)}MB` : `${Math.round(maxFileSize / 1024)}KB`;
  }, [maxFileSize]);
  if (compact) {
    return /* @__PURE__ */ jsx6(SafeErrorBoundary, { fallback: /* @__PURE__ */ jsx6("div", { children: t("file.import.error.boundary") }), children: /* @__PURE__ */ jsx6("div", { className: "file-importer-compact", children: /* @__PURE__ */ jsxs4(
      DragDropZone,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx6("label", { htmlFor: "file-input-compact", children: /* @__PURE__ */ jsx6(
            Button3,
            {
              variant: "primary",
              disabled: disabled || isProcessing,
              style: { cursor: disabled || isProcessing ? "not-allowed" : "pointer" },
              children: isProcessing ? /* @__PURE__ */ jsxs4(Fragment2, { children: [
                /* @__PURE__ */ jsx6(SafeLoadingSpinner, { size: "sm" }),
                t("file.import.processing")
              ] }) : t("file.import.select.files")
            }
          ) }),
          showProgress && isProcessing && /* @__PURE__ */ jsxs4("div", { style: { marginTop: "8px", fontSize: "12px", color: "#666" }, children: [
  ...
  return /* @__PURE__ */ jsx6(SafeErrorBoundary, { fallback: /* @__PURE__ */ jsx6("div", { children: t("file.import.error.boundary") }), children: /* @__PURE__ */ jsxs4(BaseCard, { className: "file-importer", children: [
    /* @__PURE__ */ jsxs4("div", { style: { padding: "16px", borderBottom: "1px solid #eee" }, children: [
      /* @__PURE__ */ jsx6(Heading, { as: "h3", children: title || t("file.import.title") }),
      /* @__PURE__ */ jsx6(Text, { size: "sm", color: "secondary", children: description || t("file.import.description", {
    ...
    /* @__PURE__ */ jsxs4("div", { style: { padding: "16px" }, children: [
      /* @__PURE__ */ jsxs4(
        DragDropZone,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx6("label", { htmlFor: "file-input", children: /* @__PURE__ */ jsx6(
              Button3,
              {
                variant: "primary",
                size: "lg",
      ...
      showProgress && isProcessing && /* @__PURE__ */ jsxs4("div", { style: { marginTop: "16px", padding: "12px", backgroundColor: "#f5f5f5", borderRadius: "4px" }, children: [
        /* @__PURE__ */ jsxs4("div", { style: { fontSize: "14px", marginBottom: "4px" }, children: [
          t("file.import.progress"),
          ": ",
          Math.round(progress),
          "%"
        ] }),
        /* @__PURE__ */ jsx6("div", { style: { width: "100%", height: "4px", backgroundColor: "#e0e0e0", borderRadius: "2px" }, children: /* @__PURE__ */ jsx6(
          "div",
          {
            style: {
              width: `${progress}%`,
      ...
      error && /* @__PURE__ */ jsx6("div", { style: { marginTop: "16px" }, children: /* @__PURE__ */ jsx6(Text, { color: "danger", children: error }) }),
      files.length > 0 && /* @__PURE__ */ jsxs4("div", { style: { marginTop: "16px" }, children: [
        /* @__PURE__ */ jsxs4("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }, children: [
          /* @__PURE__ */ jsx6(Text, { size: "base", weight: "medium", children: t("file.import.files.selected", { count: files.length }) }),
          /* @__PURE__ */ jsx6(
            Button3,
            {
              variant: "secondary",
      ...
      showPreview && selectedFile && /* @__PURE__ */ jsx6("div", { style: { marginTop: "16px" }, children: /* @__PURE__ */ jsx6(
        FilePreview,
        {
          file: selectedFile,

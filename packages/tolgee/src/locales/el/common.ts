...
export const elTranslations = {
  ...
  "complete": {
    "success": {
      ...
      "description": "Η καταχώρηση σας έχει ολοκληρωθεί με επιτυχία.",
      "message": "Όλες οι πληροφορίες σας έχουν αποθηκευτεί και η αίτησή σας βρίσκεται σε επεξεργασία."
    },
    "nextSteps": {
      "title": "Επόμενα Βήματα",
      "info": "Θα λάβετε ενημέρωση για την πρόοδο της αίτησής σας στο email σας.",
      "timeline": "Ο χρόνος επεξεργασίας είναι συνήθως 2-5 εργάσιμες ημέρες.",
      "contact": "Για οποιαδήποτε απορία μπορείτε να επικοινωνήσετε μαζί μας."
    },
    "actions": {
    ...
    "finish": {
      "title": "Ολοκλήρωση",
      "description": "Η καταχώρησή σας έχει ολοκληρωθεί"
    },
    "back": {
  ...
  "occupation": {
    ...
    "subtitle": "Αναζητήστε και επιλέξτε το επάγγελμά σας από την επίσημη ESCO βάση δεδομένων της ΕΕ",
    "search": {
    ...
    "skills": {
      "count": "💼 Σχετικές δεξιότητες"
    },
    "success": {
      "title": "🎉 Επιτυχία!",
      "message": "Το επάγγελμα \"{{occupation}}\" επιλέχθηκε επιτυχώς.",
      "nextStep": "Μετάβαση στο επόμενο βήμα..."
    },
    "help": {
      "tip": "💡 Συμβουλή: Χρησιμοποιήστε ελληνικούς ή αγγλικούς όρους για καλύτερα αποτελέσματα"
    }
  },
  "esco": {
    "search": {
      "error": "Σφάλμα αναζήτησης στη βάση δεδομένων ESCO",
      "searching": "Αναζήτηση επαγγελμάτων...",
      "noResults": "Δεν βρέθηκαν αποτελέσματα για: {{query}}"
    },
    "connection": {
      "connecting": "Σύνδεση με την ESCO βάση δεδομένων..."
    },
    "skills": {
      "count": "Σχετικές δεξιότητες: {{count}}"
    }
  }
} as const;

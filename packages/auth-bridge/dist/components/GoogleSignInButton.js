 ...
 * ```
 */
export function GoogleSignInButton({ children = 'Σύνδεση με Google', className = '', style, onSuccess, onError, disabled: externalDisabled = false }) {
    ...
    return (_jsx("button", { type: "button", className: `google-sign-in-button ${className}`, style: defaultStyle, onClick: handleClick, disabled: loading || externalDisabled, onMouseEnter: (e) => {
            if (!loading && !externalDisabled) {

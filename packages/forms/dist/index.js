...
var require_void_elements = __commonJS({
  "../../node_modules/.pnpm/void-elements@3.1.0/node_modules/void-elements/index.js"(exports2, module2) {
    "use strict";
    module2.exports = {
      "area": true,
      "base": true,
...
var require_url_state_machine = __commonJS({
  "../../node_modules/.pnpm/whatwg-url@5.0.0/node_modules/whatwg-url/lib/url-state-machine.js"(exports2, module2) {
    ...
    function findLongestZeroSequence(arr3) {
      let maxIdx = null;
      let maxLen = 1;
      let currStart = null;
      let currLen = 0;
...
function getNodeRequestOptions(request3) {
  ...
  if (request3.signal && request3.body instanceof import_stream.default.Readable && !streamDestructionSupported) {
...
function fetch2(url, opts) {
  ...
  return new fetch2.Promise(function(resolve, reject) {
    ...
    const abort = function abort2() {
      ...
      reject(error);
      if (request3.body && request3.body instanceof import_stream.default.Readable) {
...
var require_node_ponyfill = __commonJS({
  "../../node_modules/.pnpm/cross-fetch@4.0.0/node_modules/cross-fetch/dist/node-ponyfill.js"(exports2, module2) {
    "use strict";
...
// ../../node_modules/.pnpm/i18next-http-backend@2.7.3/node_modules/i18next-http-backend/esm/getFetch.cjs
var require_getFetch = __commonJS({
  "../../node_modules/.pnpm/i18next-http-backend@2.7.3/node_modules/i18next-http-backend/esm/getFetch.cjs"(exports2, module2) {
    "use strict";
    ...
    if (typeof require !== "undefined" && typeof window === "undefined") {
      f = fetchApi2 || require_node_ponyfill();
...
var FormField = ({
  ...
  const { t: t2 } = (0, import_tolgee.useLayeraTranslation)();
  const fieldId = id || import_react.default.useId();
  const errorId = `${fieldId}-error`;
  const hintId = `${fieldId}-hint`;
  const resolvedLabel = labelKey ? t2(labelKey) : label;
  const resolvedDescription = descriptionKey ? t2(descriptionKey) : description;
  const resolvedError = errorKey ? t2(errorKey) : error;
  const resolvedHint = hintKey ? t2(hintKey) : hint;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: fieldClasses, children: [
    resolvedLabel && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "label",
      {
        ...
        children: [
          resolvedLabel,
          required && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "layera-form-field__required", "aria-label": t2("forms.validation.required"), children: "*" })
        ]
      }
    ),
...
var Select = (0, import_react3.forwardRef)(({
  ...
  const { t: t2 } = (0, import_tolgee2.useLayeraTranslation)();
  ...
  const resolvedPlaceholder = placeholderKey ? t2(placeholderKey) : placeholder;
  const resolvedEmptyMessage = emptyMessageKey ? t2(emptyMessageKey) : emptyMessage || t2("forms.select.noOptions");
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "layera-select__indicators", children: [
            ...
            clearable && value && !loading && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "button",
              {
                ...
                onClick: handleClear,
                tabIndex: -1,
                "aria-label": t2("forms.select.clear"),
                children: "\xD7"
              }
            ),
...
var Translator = class _Translator extends EventEmitter {
  ...
  extractFromKey(key, options) {
    ...
    const keySeparator = options.keySeparator !== void 0 ? options.keySeparator : this.options.keySeparator;
    let namespaces3 = options.ns || this.options.defaultNS || [];
    ...
    if (wouldCheckForNsInKey && !seemsNaturalLanguage) {
      ...
      if (m && m.length > 0) {
        return {
          key,
          namespaces: isString(namespaces3) ? [namespaces3] : namespaces3
        };
      }
      const parts = key.split(nsSeparator);
      if (nsSeparator !== keySeparator || nsSeparator === keySeparator && this.options.ns.indexOf(parts[0]) > -1) namespaces3 = parts.shift();
  ...
  translate(keys, options, lastKey) {
    ...
    const namespace = namespaces3[namespaces3.length - 1];
  ...
  resolve(keys) {
    ...
    keys.forEach((k) => {
      ...
      usedKey = key;
      let namespaces3 = extracted.namespaces;
      if (this.options.fallbackNS) namespaces3 = namespaces3.concat(this.options.fallbackNS);
      const needsPluralHandling = options.count !== void 0 && !isString(options.count);
      const needsZeroSuffixLookup = needsPluralHandling && !options.ordinal && options.count === 0 && this.pluralResolver.shouldUseIntlApi();
      const needsContextHandling = options.context !== void 0 && (isString(options.context) || typeof options.context === "number") && options.context !== "";
      const codes = options.lngs ? options.lngs : this.languageUtils.toResolveHierarchy(options.lng || this.language, options.fallbackLng);
      namespaces3.forEach((ns) => {
        if (this.isValidLookup(found)) return;
        usedNS = ns;
...
var Connector = class extends EventEmitter {
  ...
  queueLoad(languages, namespaces3, options, callback) {
    const toLoad = {};
    const pending = {};
  ...
  prepareLoading(languages, namespaces3) {
    let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    ...
    if (isString(namespaces3)) namespaces3 = [namespaces3];
    const toLoad = this.queueLoad(languages, namespaces3, options, callback);
  ...
  load(languages, namespaces3, callback) {
    this.prepareLoading(languages, namespaces3, {}, callback);
  }
  reload(languages, namespaces3, callback) {
    this.prepareLoading(languages, namespaces3, {
      reload: true
    }, callback);
  }
  loadOne(name) {
...
// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/Trans.js
var import_react6 = require("react");

// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/TransWithoutContext.js
...
// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/utils.js
function warn() {
...
// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/unescape.js
...
// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/defaults.js
var defaultOptions = {
...
// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/i18nInstance.js
var i18nInstance;
...
// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/context.js
var import_react5 = require("react");

// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/initReactI18next.js
...
// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/useTranslation.js
...
function useTranslation(ns) {
  ...
  let namespaces3 = ns || defaultNSFromContext || i18n.options && i18n.options.defaultNS;
  namespaces3 = typeof namespaces3 === "string" ? [namespaces3] : namespaces3 || ["translation"];
  if (i18n.reportNamespaces.addUsedNamespaces) i18n.reportNamespaces.addUsedNamespaces(namespaces3);
  const ready = (i18n.isInitialized || i18n.initializedStoreOnce) && namespaces3.every((n) => hasLoadedNamespace2(n, i18n, i18nOptions));
  function getT() {
    return i18n.getFixedT(props.lng || null, i18nOptions.nsMode === "fallback" ? namespaces3 : namespaces3[0], keyPrefix);
  }
  const [t2, setT] = (0, import_react7.useState)(getT);
  let joinedNS = namespaces3.join();
  ...
  (0, import_react7.useEffect)(() => {
    ...
    if (!ready && !useSuspense) {
      if (props.lng) {
        loadLanguages2(i18n, props.lng, namespaces3, () => {
          if (isMounted.current) setT(getT);
        });
      } else {
        loadNamespaces2(i18n, namespaces3, () => {
          if (isMounted.current) setT(getT);
        });
      }
    }
  ...
  const isInitial = (0, import_react7.useRef)(true);
  (0, import_react7.useEffect)(() => {
  ...
  throw new Promise((resolve) => {
    if (props.lng) {
      loadLanguages2(i18n, props.lng, namespaces3, () => resolve());
    } else {
      loadNamespaces2(i18n, namespaces3, () => resolve());
    }
  });
}

// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/withTranslation.js
var import_react8 = require("react");

// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/I18nextProvider.js
var import_react9 = require("react");

// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/withSSR.js
var import_react11 = require("react");

// ../../node_modules/.pnpm/react-i18next@13.5.0_i18nex_1c4303c0a28d09394f8bb6ac67fc987c/node_modules/react-i18next/dist/es/useSSR.js
...
// ../../node_modules/.pnpm/i18next-http-backend@2.7.3/node_modules/i18next-http-backend/esm/utils.js
function _typeof2(o) {
  "@babel/helpers - typeof";
...
// ../../node_modules/.pnpm/i18next-http-backend@2.7.3/node_modules/i18next-http-backend/esm/request.js
...
// ../../node_modules/.pnpm/i18next-http-backend@2.7.3/node_modules/i18next-http-backend/esm/index.js
function _typeof4(o) {
  "@babel/helpers - typeof";
...
function _defineProperties2(e2, r) {
  for (var t2 = 0; t2 < r.length; t2++) {
    var o = r[t2];
    o.enumerable = o.enumerable || false, o.configurable = true, "value" in o && (o.writable = true), Object.defineProperty(e2, _toPropertyKey2(o.key), o);
  }
}
...
var getDefaults3 = function getDefaults4() {
  return {
    ...
    parseLoadPayload: function parseLoadPayload(languages, namespaces3) {
      return void 0;
    },
...
var Backend = (function() {
  ...
  return _createClass2(Backend2, [{
    ...
    value: function init2(services) {
      ...
      var allOptions = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      this.services = services;
      this.options = _objectSpread2(_objectSpread2(_objectSpread2({}, getDefaults3()), this.options || {}), options);
      this.allOptions = allOptions;
      if (this.services && this.options.reloadInterval) {
        var timer = setInterval(function() {
          return _this.reload();
        }, this.options.reloadInterval);
        if (_typeof4(timer) === "object" && typeof timer.unref === "function") timer.unref();
      }
    }
  }, {
    key: "readMulti",
    value: function readMulti(languages, namespaces3, callback) {
      this._readAny(languages, languages, namespaces3, namespaces3, callback);
    }
  }, {
    key: "read",
    ...
    key: "_readAny",
    value: function _readAny(languages, loadUrlLanguages, namespaces3, loadUrlNamespaces, callback) {
      var _this2 = this;
      var loadPath = this.options.loadPath;
      if (typeof this.options.loadPath === "function") {
        loadPath = this.options.loadPath(languages, namespaces3);
      }
    ...
    key: "loadUrl",
    value: function loadUrl(url, callback, languages, namespaces3) {
      var _this3 = this;
      var lng = typeof languages === "string" ? [languages] : languages;
      var ns = typeof namespaces3 === "string" ? [namespaces3] : namespaces3;
      ...
      this.options.request(this.options, url, payload, function(err, res) {
        ...
        try {
          if (typeof res.data === "string") {
            ret = _this3.options.parse(res.data, languages, namespaces3);
          } else {
            ret = res.data;
          }
        } catch (e2) {
...
var common_default = {
  ...
  pipeline: {
    ...
    actions: {
      reset: {
        tooltip: "\u0395\u03C0\u03B1\u03BD\u03B1\u03C6\u03BF\u03C1\u03AC - \u0395\u03BC\u03C6\u03AC\u03BD\u03B9\u03C3\u03B7 \u03C0\u03BB\u03AE\u03BA\u03C4\u03C1\u03BF\u03C5 \u03C0\u03C1\u03BF\u03C3\u03B8\u03AE\u03BA\u03B7\u03C2"
      }
    },
    forms: {
      details: {
        title: "\u03A6\u03CC\u03C1\u03BC\u03B1 \u039B\u03B5\u03C0\u03C4\u03BF\u03BC\u03B5\u03C1\u03B5\u03B9\u03CE\u03BD",
        placeholder: "\u0398\u03B1 \u03C0\u03C1\u03BF\u03C3\u03C4\u03B5\u03B8\u03B5\u03AF \u03C4\u03BF form \u03C0\u03B5\u03C1\u03B9\u03B5\u03C7\u03CC\u03BC\u03B5\u03BD\u03BF \u03B5\u03B4\u03CE..."
      }
    }
  },
  dashboard: {
  ...
  pipeline: {
    ...
    intent: {
      ...
      offer: {
        ...
        job: {
          title: "I Want to Offer Position",
          description: "Post a job listing for an available position."
        }
      },
      search: {
    ...
    actions: {
      reset: {
        tooltip: "Reset - Show add button"
      }
    },
    forms: {
      details: {
        title: "Details Form",
        placeholder: "Form content will be added here..."
      }
    }
  }
};

// ../i18n/src/locales/el/dashboard.json
...
// ../i18n/src/locales/en/dashboard.json
...
var namespaces = ["common", "dashboard"];
var resources = {
  el: {
...
instance.use(esm_default).use(Browser).use(initReactI18next).init(i18nConfig);

// ../i18n/src/hooks/useLayeraTranslation.ts
function useLayeraTranslation3(ns = defaultNS, options) {
  const { t: t2, i18n, ready } = useTranslation(ns, {
    useSuspense: false,
    ...options
  });
  ...
  const formatters = {
     ...
     * Format role name
     */
    role: (role) => t2(`roles.${role}`, { defaultValue: role }),
    /**
     * Format status
     */
    status: (status) => t2(`status.${status}`, { defaultValue: status }),
    /**
     * Format action
     */
    action: (action) => t2(`actions.${action}`, { defaultValue: action }),
    /**
     * Format error message
     */
    error: (error) => t2(`errors.${error}`, { defaultValue: error })
  };
  return {
    t: t2,
    i18n,
...
// ../i18n/src/components/LanguageSwitcher.tsx
var import_react12 = require("react");
var import_jsx_runtime4 = require("react/jsx-runtime");

// ../i18n/src/components/LayeraI18nProvider.tsx
var import_react13 = require("react");
var import_jsx_runtime5 = require("react/jsx-runtime");
var I18nContext2 = (0, import_react13.createContext)(null);
...
var FormSection = ({
  ...
  const { t: t2 } = useLayeraTranslation3();
  const [isCollapsed, setIsCollapsed] = import_react14.default.useState(defaultCollapsed);
  const resolvedTitle = titleKey ? t2(titleKey) : title;
  const resolvedDescription = descriptionKey ? t2(descriptionKey) : description;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: sectionClasses, children: [
    (resolvedTitle || icon) && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "div",
      {
        ...
        children: [
          icon && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "layera-form-section__icon", children: icon }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "layera-form-section__header-content", children: [
            resolvedTitle && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { className: "layera-form-section__title", children: resolvedTitle }),
            resolvedDescription && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "layera-form-section__description", children: resolvedDescription })
          ] }),
          collapsible && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "layera-form-section__toggle", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "svg",
            {
              width: "16",
              height: "16",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "layera-form-section__content", children })
  ] });
};
...
var FormActions = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: actionsClasses, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "layera-form-actions__content", children }) });
};
...
var TextArea = (0, import_react15.forwardRef)(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: wrapperClasses, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    "textarea",
    {
      ref,
      disabled,
...
var Checkbox = (0, import_react16.forwardRef)(({
  ...
  const combinedRef = import_react16.default.useCallback((node) => {
  ...
  const renderIcon = () => {
    if (loading) {
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "layera-checkbox__spinner" });
    }
    if (indeterminate) {
      return indeterminateIcon || /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "layera-checkbox__minus" });
    }
    if (checked) {
      return checkedIcon || /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("svg", { className: "layera-checkbox__check", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("polyline", { points: "20,6 9,17 4,12", stroke: "currentColor", strokeWidth: "2" }) });
    }
    return null;
  };
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: wrapperClasses, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "layera-checkbox__control", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: boxClasses, children: renderIcon() })
    ] }),
    (label || description || error) && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "layera-checkbox__content", children: [
      ...
      description && !error && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "layera-checkbox__description", children: description }),
...
var NumericInput = (0, import_react17.forwardRef)(({
  ...
  const incrementRef = (0, import_react17.useRef)(null);
  const decrementRef = (0, import_react17.useRef)(null);
  const longPressTimerRef = (0, import_react17.useRef)(null);
  const longPressIntervalRef = (0, import_react17.useRef)(null);
  const actualState = error ? import_constants6.FORM_STATES.ERROR : state;
  const formatDisplayValue = (0, import_react17.useCallback)((val) => {
  ...
  const parseInputValue = (0, import_react17.useCallback)((inputVal) => {
  ...
  const validateValue2 = (0, import_react17.useCallback)((val) => {
  ...
  const incrementValue = (0, import_react17.useCallback)(() => {
    const currentValue = value || 0;
    const newValue = currentValue + step;
    const validatedValue = validateValue2(newValue);
    if (validatedValue !== void 0 && onChange) {
      onChange(validatedValue);
    }
  }, [value, step, validateValue2, onChange]);
  const decrementValue = (0, import_react17.useCallback)(() => {
    const currentValue = value || 0;
    const newValue = currentValue - step;
    const validatedValue = validateValue2(newValue);
    if (validatedValue !== void 0 && onChange) {
  ...
  const handleInputChange = (0, import_react17.useCallback)((event) => {
    const inputValue = event.target.value;
    const parsedValue = parseInputValue(inputValue);
    const validatedValue = validateValue2(parsedValue);
    if (onChange) {
      onChange(validatedValue);
    }
  }, [parseInputValue, validateValue2, onChange]);
  const handleWheel = (0, import_react17.useCallback)((event) => {
  ...
  const startLongPress = (0, import_react17.useCallback)((action) => {
  ...
  const stopLongPress = (0, import_react17.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: wrapperClasses, children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { htmlFor: inputId, className: "layera-numeric-input__label", children: [
      label,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "layera-numeric-input__control", children: [
      stepperPosition === "separate" && showSteppers && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "button",
        {
          ref: decrementRef,
          type: "button",
          ...
          "aria-label": t2("forms.decrement"),
          children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("svg", { viewBox: "0 0 24 24", fill: "none", className: "layera-numeric-input__stepper-icon", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("line", { x1: "5", y1: "12", x2: "19", y2: "12", stroke: "currentColor", strokeWidth: "2" }) })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "layera-numeric-input__input-wrapper", children: [
        prefix && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "layera-numeric-input__prefix", children: prefix }),
        ...
        suffix && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "layera-numeric-input__suffix", children: suffix }),
        loading && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "layera-numeric-input__loading", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "layera-numeric-input__spinner" }) }),
        stepperPosition === "inline" && showSteppers && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "layera-numeric-input__steppers-inline", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            "button",
            {
              ...
              onMouseUp: stopLongPress,
              onMouseLeave: stopLongPress,
              "aria-label": t2("forms.increment"),
              children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", className: "layera-numeric-input__stepper-icon", children: [
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("line", { x1: "12", y1: "5", x2: "12", y2: "19", stroke: "currentColor", strokeWidth: "2" }),
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("line", { x1: "5", y1: "12", x2: "19", y2: "12", stroke: "currentColor", strokeWidth: "2" })
              ] })
            }
          )
        ] })
      ] }),
      stepperPosition === "right" && showSteppers && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "layera-numeric-input__steppers-right", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "button",
          {
            ref: incrementRef,
            ...
            onMouseLeave: stopLongPress,
            "aria-label": t2("forms.increment"),
            children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("svg", { viewBox: "0 0 24 24", fill: "none", className: "layera-numeric-input__stepper-icon", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("polyline", { points: "18,15 12,9 6,15", stroke: "currentColor", strokeWidth: "2" }) })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "button",
          {
            ...
            onMouseLeave: stopLongPress,
            "aria-label": t2("forms.decrement"),
            children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("svg", { viewBox: "0 0 24 24", fill: "none", className: "layera-numeric-input__stepper-icon", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("polyline", { points: "6,9 12,15 18,9", stroke: "currentColor", strokeWidth: "2" }) })
          }
        )
      ] }),
      stepperPosition === "separate" && showSteppers && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    ...
    (description || error) && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "layera-numeric-input__footer", children: [
      description && !error && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "layera-numeric-input__description", children: description }),
...
var Slider = (0, import_react18.forwardRef)(({
  ...
  const [isDragging, setIsDragging] = (0, import_react18.useState)(null);
  const [showTooltips, setShowTooltips] = (0, import_react18.useState)([false, false]);
  ...
  const formatDisplayValue = (0, import_react18.useCallback)((val) => {
    if (formatValue) {
      return formatValue(val);
    }
    return val.toString();
  }, [formatValue]);
  const getValueFromPosition = (0, import_react18.useCallback)((clientX, clientY) => {
  ...
  const getPercentageFromValue = (0, import_react18.useCallback)((val) => {
    const percentage = (val - min) / (max - min);
    return reverse ? 100 - percentage * 100 : percentage * 100;
  }, [min, max, reverse]);
  const handlePointerStart = (0, import_react18.useCallback)((event, thumbIndex) => {
    if (disabled || loading) return;
    event.preventDefault();
  ...
  const handlePointerMove = (0, import_react18.useCallback)((event) => {
  ...
  const handlePointerEnd = (0, import_react18.useCallback)((event) => {
    if (isDragging === null) return;
    setIsDragging(null);
    setShowTooltips([false, false]);
    event.target.releasePointerCapture(event.pointerId);
  }, [isDragging]);
  const handleTrackClick = (0, import_react18.useCallback)((event) => {
  ...
  const generateMarks = (0, import_react18.useCallback)(() => {
    if (!marks) return [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: wrapperClasses, ...props, ref, children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { htmlFor: sliderId, className: "layera-slider__label", children: [
      label,
      props.required && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        "span",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "layera-slider__container", children: [
      showValue && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__values", children: range ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "layera-slider__value", children: formatDisplayValue(minValue) }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "layera-slider__value-separator", children: "-" }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "layera-slider__value", children: formatDisplayValue(maxValue) })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "layera-slider__value", children: formatDisplayValue(maxValue) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "layera-slider__track-container", children: [
        sliderMarks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__marks", children: sliderMarks.map((mark, index) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
          "div",
          {
            className: "layera-slider__mark",
            style: getThumbStyle(mark.value),
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__mark-dot" }),
              mark.label && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__mark-label", children: mark.label })
            ]
          },
          index
        )) }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__track-background" }),
              ...
              !range && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                "div",
                {
                  className: "layera-slider__thumb",
                  style: getThumbStyle(maxValue),
                  onPointerDown: (e2) => handlePointerStart(e2, 0),
                  ...
                  tabIndex: disabled ? -1 : 0,
                  children: showTooltip && showTooltips[0] && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__tooltip", children: formatDisplayValue(maxValue) })
                }
              ),
              range && /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                  "div",
                  {
                    ...
                    tabIndex: disabled ? -1 : 0,
                    children: showTooltip && showTooltips[0] && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__tooltip", children: formatDisplayValue(minValue) })
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
                  "div",
                  {
                    ...
                    style: getThumbStyle(maxValue),
                    onPointerDown: (e2) => handlePointerStart(e2, 1),
                    onPointerMove: handlePointerMove,
                    onPointerUp: handlePointerEnd,
                    onPointerCancel: handlePointerEnd,
                    role: "slider",
                    ...
                    "aria-valuetext": formatDisplayValue(maxValue),
                    tabIndex: disabled ? -1 : 0,
                    children: showTooltip && showTooltips[1] && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__tooltip", children: formatDisplayValue(maxValue) })
                  }
                )
              ] })
            ]
      ...
      loading && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__loading", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__spinner" }) })
    ] }),
    (description || error) && /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "layera-slider__footer", children: [
      description && !error && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "layera-slider__description", children: description }),
...
var DatePicker = (0, import_react19.forwardRef)(({
  ...
  const [displayDate, setDisplayDate] = (0, import_react19.useState)(() => value || /* @__PURE__ */ new Date());
  ...
  const formatDate = (0, import_react19.useCallback)((date) => {
    if (!date) return "";
    try {
  ...
  const parseDate = (0, import_react19.useCallback)((dateString) => {
  ...
  const isDisabled = (0, import_react19.useCallback)((date) => {
    if (isDateDisabled && isDateDisabled(date)) return true;
    if (minDate && date < minDate) return true;
    if (maxDate && date > maxDate) return true;
    return false;
  }, [isDateDisabled, minDate, maxDate]);
  const isSelected = (0, import_react19.useCallback)((date) => {
    if (multiple) {
  ...
  const handleInputChange = (0, import_react19.useCallback)((event) => {
  ...
  const handleDateSelect = (0, import_react19.useCallback)((date) => {
  ...
  const handleToday = (0, import_react19.useCallback)(() => {
    const today = /* @__PURE__ */ new Date();
    handleDateSelect(today);
  }, [handleDateSelect]);
  const handleClear = (0, import_react19.useCallback)(() => {
    if (onChange) {
      onChange(void 0);
    }
    if (onRangeChange) {
  ...
  const navigateMonth = (0, import_react19.useCallback)((direction) => {
    setDisplayDate((prev) => {
  ...
  const generateCalendarDays = (0, import_react19.useCallback)((baseDate) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: wrapperClasses, ref: containerRef, children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("label", { htmlFor: datePickerId, className: "layera-datepicker__label", children: [
      label,
      props.required && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "span",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "layera-datepicker__input-wrapper", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "input",
        {
          ...
          disabled: disabled || loading,
          placeholder: placeholder || t2("datepicker.selectDate"),
          className: inputClasses,
          ...props
        }
      ),
      showCalendar && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        "button",
        {
          type: "button",
          ...
          disabled: disabled || loading,
          "aria-label": t2("datepicker.selectDate"),
          children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", className: "layera-datepicker__calendar-icon", children: [
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("rect", { x: "3", y: "4", width: "18", height: "18", rx: "2", ry: "2", stroke: "currentColor", strokeWidth: "2" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("line", { x1: "16", y1: "2", x2: "16", y2: "6", stroke: "currentColor", strokeWidth: "2" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("line", { x1: "8", y1: "2", x2: "8", y2: "6", stroke: "currentColor", strokeWidth: "2" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("line", { x1: "3", y1: "10", x2: "21", y2: "10", stroke: "currentColor", strokeWidth: "2" })
          ] })
        }
      ),
      loading && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "layera-datepicker__loading", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "layera-datepicker__spinner" }) })
    ] }),
    isOpen && showCalendar && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "layera-datepicker__calendar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "layera-datepicker__header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "button",
          {
            type: "button",
            ...
            "aria-label": t2("datepicker.previous"),
            children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("polyline", { points: "15,18 9,12 15,6", stroke: "currentColor", strokeWidth: "2" }) })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "layera-datepicker__month-year", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "button",
          {
            ...
            "aria-label": t2("datepicker.next"),
            children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("polyline", { points: "9,18 15,12 9,6", stroke: "currentColor", strokeWidth: "2" }) })
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "layera-datepicker__weekdays", children: WEEKDAYS.map((day) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "layera-datepicker__weekday", children: day }, day)) }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "layera-datepicker__days", children: calendarDays.map((date, index) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "layera-datepicker__footer", children: [
        showToday && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "button",
          {
            type: "button",
            className: "layera-datepicker__today",
            onClick: handleToday,
            children: t2("datepicker.today")
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "button",
          {
            ...
            onClick: handleClear,
            children: t2("datepicker.clear")
          }
        )
      ] })
    ] }),
    (description || error) && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "layera-datepicker__footer-text", children: [
      description && !error && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "layera-datepicker__description", children: description }),
...
var InputGroupContext = import_react20.default.createContext(void 0);
var InputGroupItem = (0, import_react20.forwardRef)(({
  name,
  flex,
  minWidth,
  maxWidth,
  ...
  const context = import_react20.default.useContext(InputGroupContext);
  if (!context) {
  ...
  const enhancedChildren = import_react20.default.Children.map(children, (child) => {
    if (import_react20.default.isValidElement(child)) {
      ...
      return import_react20.default.cloneElement(child, commonProps);
    }
    return child;
  });
...
var InputGroup = (0, import_react20.forwardRef)(({
  ...
  const [values, setValues] = import_react20.default.useState({});
  const actualState = error ? import_constants9.FORM_STATES.ERROR : state;
  const handleItemChange = (0, import_react20.useCallback)((name, value) => {
    setValues((prev) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: wrapperClasses, ref, children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("label", { htmlFor: groupId, className: "layera-input-group__label", children: [
      label,
      required && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
        "span",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(InputGroupContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      "div",
      {
        id: groupId,
        ...
        children: [
          children,
          loading && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "layera-input-group__loading", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "layera-input-group__spinner" }) })
        ]
      }
    ) }),
    (description || error) && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "layera-input-group__footer", children: [
      description && !error && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "layera-input-group__description", children: description }),

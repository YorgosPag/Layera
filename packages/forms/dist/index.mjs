...
var require_getFetch = __commonJS({
  "../../node_modules/.pnpm/i18next-http-backend@2.7.3/node_modules/i18next-http-backend/esm/getFetch.cjs"(exports, module) {
    "use strict";
...
var FormField = ({
  ...
  const { t: t2 } = useLayeraTranslation();
  ...
  return /* @__PURE__ */ jsxs("div", { className: fieldClasses, children: [
    resolvedLabel && /* @__PURE__ */ jsxs(
      "label",
      {
        ...
        children: [
          resolvedLabel,
          required && /* @__PURE__ */ jsx("span", { className: "layera-form-field__required", "aria-label": t2("forms.validation.required"), children: "*" })
        ]
      }
    ),
...
var Select = forwardRef2(({
  ...
  const { t: t2 } = useLayeraTranslation2();
...
import React4, { isValidElement, cloneElement, createElement, Children } from "react";
...
import { useState as useState2, useEffect as useEffect2, useContext as useContext2, useRef as useRef2 } from "react";
...
import { createContext as createContext2, useContext as useContext4, useEffect as useEffect4, useState as useState4 } from "react";
...
var FormSection = ({
  ...
  const [isCollapsed, setIsCollapsed] = React7.useState(defaultCollapsed);
  ...
  return /* @__PURE__ */ jsxs5("div", { className: sectionClasses, children: [
    (resolvedTitle || icon) && /* @__PURE__ */ jsxs5(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs5("div", { className: "layera-form-section__header-content", children: [
...
var Checkbox = forwardRef4(({
  ...
  const combinedRef = React9.useCallback((node) => {
  ...
  return /* @__PURE__ */ jsxs6("div", { className: wrapperClasses, children: [
    /* @__PURE__ */ jsxs6("div", { className: "layera-checkbox__control", children: [
      /* @__PURE__ */ jsx9(
        "input",
        {
          ref: combinedRef,
    ...
    (label || description || error) && /* @__PURE__ */ jsxs6("div", { className: "layera-checkbox__content", children: [
...
import { forwardRef as forwardRef5, useCallback, useEffect as useEffect5, useRef as useRef3 } from "react";
import {
...
var NumericInput = forwardRef5(({
  ...
  const incrementRef = useRef3(null);
  const decrementRef = useRef3(null);
  const longPressTimerRef = useRef3(null);
  const longPressIntervalRef = useRef3(null);
  ...
  const validateValue2 = useCallback((val) => {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: wrapperClasses, children: [
    label && /* @__PURE__ */ jsxs7("label", { htmlFor: inputId, className: "layera-numeric-input__label", children: [
      label,
    ...
    /* @__PURE__ */ jsxs7("div", { className: "layera-numeric-input__control", children: [
      ...
      /* @__PURE__ */ jsxs7("div", { className: "layera-numeric-input__input-wrapper", children: [
        ...
        stepperPosition === "inline" && showSteppers && /* @__PURE__ */ jsxs7("div", { className: "layera-numeric-input__steppers-inline", children: [
          /* @__PURE__ */ jsx10(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsx10(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxs7("svg", { viewBox: "0 0 24 24", fill: "none", className: "layera-numeric-input__stepper-icon", children: [
      ...
      stepperPosition === "right" && showSteppers && /* @__PURE__ */ jsxs7("div", { className: "layera-numeric-input__steppers-right", children: [
        /* @__PURE__ */ jsx10(
          "button",
          {
            ref: incrementRef,
    ...
    (description || error) && /* @__PURE__ */ jsxs7("div", { className: "layera-numeric-input__footer", children: [
...
import { forwardRef as forwardRef6, useCallback as useCallback2, useRef as useRef4, useState as useState5 } from "react";
import {
...
var Slider = forwardRef6(({
  ...
  const [isDragging, setIsDragging] = useState5(null);
  const [showTooltips, setShowTooltips] = useState5([false, false]);
  ...
  return /* @__PURE__ */ jsxs8("div", { className: wrapperClasses, ...props, ref, children: [
    label && /* @__PURE__ */ jsxs8("label", { htmlFor: sliderId, className: "layera-slider__label", children: [
      label,
    ...
    /* @__PURE__ */ jsxs8("div", { className: "layera-slider__container", children: [
      showValue && /* @__PURE__ */ jsx11("div", { className: "layera-slider__values", children: range ? /* @__PURE__ */ jsxs8(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs8("div", { className: "layera-slider__track-container", children: [
        sliderMarks.length > 0 && /* @__PURE__ */ jsx11("div", { className: "layera-slider__marks", children: sliderMarks.map((mark, index) => /* @__PURE__ */ jsxs8(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs8(
          "div",
          {
            ...
            children: [
              ...
              range && /* @__PURE__ */ jsxs8(Fragment, { children: [
                /* @__PURE__ */ jsx11(
                  "div",
                  {
    ...
    (description || error) && /* @__PURE__ */ jsxs8("div", { className: "layera-slider__footer", children: [
...
import { forwardRef as forwardRef7, useCallback as useCallback3, useEffect as useEffect7, useRef as useRef5, useState as useState6 } from "react";
import {
...
var DatePicker = forwardRef7(({
  ...
  const [displayDate, setDisplayDate] = useState6(() => value || /* @__PURE__ */ new Date());
  ...
  return /* @__PURE__ */ jsxs9("div", { className: wrapperClasses, ref: containerRef, children: [
    label && /* @__PURE__ */ jsxs9("label", { htmlFor: datePickerId, className: "layera-datepicker__label", children: [
      label,
    ...
    /* @__PURE__ */ jsxs9("div", { className: "layera-datepicker__input-wrapper", children: [
      /* @__PURE__ */ jsx12(
        "input",
        {
          ref: ref || inputRef,
      ...
      showCalendar && /* @__PURE__ */ jsx12(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxs9("svg", { viewBox: "0 0 24 24", fill: "none", className: "layera-datepicker__calendar-icon", children: [
    ...
    isOpen && showCalendar && /* @__PURE__ */ jsxs9("div", { className: "layera-datepicker__calendar", children: [
      /* @__PURE__ */ jsxs9("div", { className: "layera-datepicker__header", children: [
        /* @__PURE__ */ jsx12(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxs9("div", { className: "layera-datepicker__month-year", children: [
      ...
      /* @__PURE__ */ jsxs9("div", { className: "layera-datepicker__footer", children: [
    ...
    (description || error) && /* @__PURE__ */ jsxs9("div", { className: "layera-datepicker__footer-text", children: [
...
import React13, { forwardRef as forwardRef8, useCallback as useCallback4, useMemo as useMemo2 } from "react";
import {
  FORM_SIZES as FORM_SIZES8,
  FORM_STATES as FORM_STATES9
} from "@layera/constants";
import { jsx as jsx13, jsxs as jsxs10 } from "react/jsx-runtime";
var InputGroupContext = React13.createContext(void 0);
var InputGroupItem = forwardRef8(({
  ...
  const context = React13.useContext(InputGroupContext);
  if (!context) {
  ...
  const enhancedChildren = React13.Children.map(children, (child) => {
    if (React13.isValidElement(child)) {
      ...
      return React13.cloneElement(child, commonProps);
    }
    return child;
  });
...
var InputGroup = forwardRef8(({
  ...
  const [values, setValues] = React13.useState({});
  ...
  return /* @__PURE__ */ jsxs10("div", { className: wrapperClasses, ref, children: [
    label && /* @__PURE__ */ jsxs10("label", { htmlFor: groupId, className: "layera-input-group__label", children: [
      label,
    ...
    /* @__PURE__ */ jsx13(InputGroupContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsxs10(
      "div",
      {
        id: groupId,
    ...
    (description || error) && /* @__PURE__ */ jsxs10("div", { className: "layera-input-group__footer", children: [

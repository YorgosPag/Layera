...
function useGeocode(options = {}) {
  ...
  const debouncedSearch = (0, import_react.useCallback)((searchQuery) => {
  ...
  const selectResult = (0, import_react.useCallback)((result) => {
...
// src/index.ts
var LAYERA_GEOCODING_VERSION = "1.0.0";
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  LAYERA_GEOCODING_VERSION,
  nominatimProvider,
  useGeocode
});

...
export const MeasurementCanvas: React.FC<MeasurementCanvasProps> = ({
  ...
  const getColors = useCallback(() => {
    ...
    return {
      line: isDark ? 'var(--la-color-blue-400, #60a5fa)' : 'var(--la-color-blue-600, #3b82f6)',
      fill: isDark ? 'var(--la-color-blue-400-alpha-20, rgba(96, 165, 250, 0.2))' : 'var(--la-color-blue-600-alpha-20, rgba(59, 130, 246, 0.2))',
      point: isDark ? 'var(--la-color-amber-500, #f59e0b)' : 'var(--la-color-amber-600, #d97706)',
      pointBorder: isDark ? 'var(--la-color-gray-800, #1f2937)' : 'var(--la-color-white, #ffffff)'
    };
  }, [theme]);

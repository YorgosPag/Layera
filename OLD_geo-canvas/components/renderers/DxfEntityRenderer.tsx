...
import { DxfEntity, DxfVertex, DxfData, DxfRenderInfo, getEntityColor, ColorContext } from '../utils/dxfUtils';
...
// FIX: Added 'dxfRenderInfo' to the destructured props to resolve reference error.
    ...
    switch (entity.type) {
        ...
        case 'INSERT':
            if (entity.block && dxfData.blocks && dxfData.blocks[entity.block]) {
                ...
                // FIX: Create and pass down a new context for color inheritance within blocks.
                // This allows entities inside the block with color "BYBLOCK" or "BYLAYER"
                // to correctly inherit the color from this INSERT entity.

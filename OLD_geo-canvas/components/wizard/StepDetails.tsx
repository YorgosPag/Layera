...
import { ListingDetails, JobDetails } from '../../shared/types';
...
const StepDetails: React.FC = () => {
    ...
    const handleDetailsChange = useCallback((
        ...
        if (field.startsWith('amenities.')) {
            ...
            // FIX: Ensure the amenities object remains complete by merging with the existing amenities or a default object.
    ...
    return (
        <div className="space-y-2">
            ...
            <AccordionSection title="4. Παροχές" isOpen={openSection === 'amenities'} onToggle={() => toggleSection('amenities')}>
                {/* FIX: Corrected type cast to use AmenityKey, which excludes symbol types and resolves the type error. */}

...
import { JobDetails, EmploymentType } from '../../../shared/types';

interface JobInfoFormProps {
    details: Partial<JobDetails>;
    onChange: (field: keyof JobDetails, value: any) => void;
}
...
const JobInfoForm: React.FC<JobInfoFormProps> = ({ details, onChange }) => {
    return (
        <div className="space-y-4">
            <div>
                <label htmlFor="jobTitle" className="block text-sm font-medium text-gray-700">Τίτλος Θέσης</label>
                <input
                    type="text"
                    id="jobTitle"
            ...
            <div>
                <label htmlFor="employmentType" className="block text-sm font-medium text-gray-700">Είδος Απασχόλησης</label>
                <select
                    id="employmentType"
            ...
            <div>
                <label htmlFor="job-description" className="block text-sm font-medium text-gray-700">Περιγραφή Θέσης</label>
                <textarea
                    id="job-description"
                    rows={5}

...
|----|--------|-------------|---------|-----------|
| [MOB-001](mobile/-.md#console-log-elimination) | Production Console Logging | 🚨 HIGH | FloatingStepper.tsx | OPEN |
| [MOB-002](mobile/-.md#hardcoded-magic-values) | Hardcoded Magic Values | 🚨 HIGH | Multiple files | OPEN |
| [MOB-003](mobile/-.md#massive-inline-styling) | Massive Inline Styling | 🚨 HIGH | BaseCard.tsx | OPEN |
| [MOB-004](mobile/-.md#component-size-violations) | Component Size Violations | 🔶 MED | FloatingStepper.tsx | OPEN |
...
- **[-](mobile/-.md)**
  - Comprehensive analysis του - pipeline system

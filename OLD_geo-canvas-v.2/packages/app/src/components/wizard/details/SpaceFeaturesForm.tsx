    ...
    return (
        <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
                <div>
                    <label htmlFor="bedrooms" className="block text-sm font-medium text-gray-700">Υπνοδωμάτια <span className="text-red-500">*</span></label>
                ...
                <div>
                    <label htmlFor="bathrooms" className="block text-sm font-medium text-gray-700">Μπάνια <span className="text-red-500">*</span></label>

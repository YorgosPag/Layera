...
const BasicInfoForm: React.FC<BasicInfoFormProps> = ({ details, onChange }) => {
    return (
        <div className="space-y-4">
            <div>
                <label htmlFor="price" className="block text-sm font-medium text-gray-700">Τιμή (€) <span className="text-red-500">*</span></label>
                <input
                    type="number"
                    id="price"
            ...
            <div>
                <label htmlFor="area" className="block text-sm font-medium text-gray-700">Εμβαδόν (τ.μ.) <span className="text-red-500">*</span></label>
                <input
                    type="number"
                    id="area"
                    // FIX: Added nullish coalescing operator to handle potentially undefined value.
            ...
            <div>
                <label htmlFor="propertyType" className="block text-sm font-medium text-gray-700">Είδος Ακινήτου <span className="text-red-500">*</span></label>
                <select
                    id="propertyType"
                    // FIX: Added nullish coalescing operator to handle potentially undefined value.

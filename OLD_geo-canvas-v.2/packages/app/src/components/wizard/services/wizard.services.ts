...
export const generateListingName = (
    ...
    if (category === 'job') {
        ...
        const typeText = employmentType ? {
            ...
            freelance: 'Freelance', seasonal: 'Εποχιακής Εργασίας', internship: 'Πρακτικής Άσκησης'
 ...
 */
export const createLayerFromDrawing = (drawingState: DrawingState, intent: ListingIntent | null, category: ListingCategory | null): ImportedLayer | null => {
    ...
    if ((drawingState.shape === 'polygon' || drawingState.shape === 'freehand') && drawingState.points.length > 2) {

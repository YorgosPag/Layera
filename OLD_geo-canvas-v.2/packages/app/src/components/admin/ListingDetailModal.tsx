                    ...
                    <dl className="divide-y divide-gray-200">
                        ...
                        {listing.category === 'property' && (
                            <>
                                ...
                                <DetailRow label="Φωτογραφίες" value={details.photos && details.photos.length > 0 ? `Ναι (${details.photos.length})` : 'Όχι'} />
                                <DetailRow label="Κάτοψη" value={listing.type === 'dxf' || listing.type === 'raster' ? 'Ναι' : 'Όχι'} />
                            </>
                        )}

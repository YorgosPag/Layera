...
export type EmploymentType = 'full_time' | 'part_time' | 'freelance' | 'seasonal' | 'internship';
export type Availability = 'now' | 'future';
export type DrawingShape = 'polygon' | 'marker' | 'freehand';
...
export interface WizardState {
    isActive: boolean;
    step: 'category' | 'intent' | 'transactionType' | 'employmentType' | 'availability' | 'locationMethod' | 'availabilityDetails' | 'location' | 'details' | 'complete';

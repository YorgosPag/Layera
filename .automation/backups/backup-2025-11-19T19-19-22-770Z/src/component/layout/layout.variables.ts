...
export const LAYOUT_CONTAINERS: LayoutContainers = {
  ...
  modal: '600px',       // Modal container width
...
export const LAYOUT_DIMENSIONS: LayoutDimensions = {
  headerHeight: '4rem',               // 64px standard header
...
// MODAL SPECIFIC DIMENSIONS
export const MODAL_DIMENSIONS = {
  small: '400px',      // Small modal (forms, confirmations)
  medium: '600px',     // Medium modal (detailed forms)
  large: '800px',      // Large modal (complex content)
  overlay: '100vw',    // Full viewport overlay
  backdrop: '100vh',   // Full height backdrop
} as const;
...
export const RESPONSIVE_LAYOUT = {
  ...
  desktop: {
    ...
    modalWidth: LAYOUT_CONTAINERS.modal, // Fixed modal width
...
export const LAYOUT_CSS_VARS = {
  ...
  '--layera-layout-container-modal': LAYOUT_CONTAINERS.modal,
  ...
  // Modal dimensions
  '--layera-layout-modal-small': MODAL_DIMENSIONS.small,
  '--layera-layout-modal-medium': MODAL_DIMENSIONS.medium,
  '--layera-layout-modal-large': MODAL_DIMENSIONS.large,
...
export {
  ...
  MODAL_DIMENSIONS as ModalDimensions,

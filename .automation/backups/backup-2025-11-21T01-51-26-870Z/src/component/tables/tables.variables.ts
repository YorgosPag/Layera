...
export const TABLE_VARIABLES = {
  ...
  'table-text-align-horizontal-left': 'var(--layera-core-text-align-left)',
  'table-text-align-horizontal-center': 'var(--layera-core-text-align-center)',
  'table-text-align-horizontal-right': 'var(--layera-core-text-align-right)',
  'table-text-align-horizontal-justify': 'var(--layera-core-text-align-justify)',
  'table-text-align-vertical-top': 'var(--layera-core-text-align-vertical-top)',
  'table-text-align-vertical-middle': 'var(--layera-core-text-align-vertical-middle)',
  'table-text-align-vertical-bottom': 'var(--layera-core-text-align-vertical-bottom)',
} as const;

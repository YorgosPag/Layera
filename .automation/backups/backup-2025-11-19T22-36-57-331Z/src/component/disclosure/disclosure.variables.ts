...
export const DISCLOSURE_VARIABLES = {
  ...
  'accordion-header-padding': `${SPACING_VARIABLES['spacing-4']} ${SPACING_VARIABLES['spacing-6']}`,
  ...
  'accordion-content-padding': `${SPACING_VARIABLES['spacing-4']} ${SPACING_VARIABLES['spacing-6']}`,
  ...
  'accordion-animation-duration': MOTION_VARIABLES['motion-duration-normal'],
  'accordion-animation-easing': MOTION_VARIABLES['motion-easing-ease-in-out'],
  'accordion-transition': `all ${MOTION_VARIABLES['motion-duration-normal']} ${MOTION_VARIABLES['motion-easing-ease-in-out']}`,
  ...
  'accordion-md-header-padding': `${SPACING_VARIABLES['spacing-4']} ${SPACING_VARIABLES['spacing-6']}`,
  'accordion-md-content-padding': `${SPACING_VARIABLES['spacing-4']} ${SPACING_VARIABLES['spacing-6']}`,
  ...
  'tabs-indicator-transition': `all ${MOTION_VARIABLES['motion-duration-fast']} ${MOTION_VARIABLES['motion-easing-ease-out']}`,
  ...
  'collapsible-content-animation': `slideDown ${MOTION_VARIABLES['motion-duration-normal']} ${MOTION_VARIABLES['motion-easing-ease-out']}`,

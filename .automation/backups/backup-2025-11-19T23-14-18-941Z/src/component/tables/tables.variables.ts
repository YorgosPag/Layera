...
export const TABLE_VARIABLES = {
  ...
  'table-loading-animation': 'pulse var(--layera-motion-duration-slow) infinite',
  ...
  // Transitions
  'table-transition': 'background-color var(--layera-motion-duration-fast) var(--layera-motion-easing-ease)',
  'table-row-transition': 'background-color var(--layera-motion-duration-fast) var(--layera-motion-easing-ease)',

...
export const FEEDBACK_COMPONENT_VARIABLES = {
  ...
  'feedback-transition': 'all var(--layera-motion-duration-normal) var(--layera-motion-easing-ease)',
  'feedback-slide-transition': 'transform var(--layera-motion-duration-normal) var(--layera-motion-easing-ease)',
  'feedback-fade-transition': 'opacity var(--layera-motion-duration-fast) var(--layera-motion-easing-ease)',

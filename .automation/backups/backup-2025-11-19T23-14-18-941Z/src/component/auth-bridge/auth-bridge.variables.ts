...
export const AUTH_BRIDGE_VARIABLES = {
  ...
  'auth-loading-animation-duration': MOTION_VARIABLES['motion-duration-slow'],
  ...
  'auth-form-transition': `all ${MOTION_VARIABLES['motion-duration-normal']} ${MOTION_VARIABLES['motion-easing-ease']}`,
  'auth-input-focus-transition': `border-color ${MOTION_VARIABLES['motion-duration-fast']} ${MOTION_VARIABLES['motion-easing-ease']}`,
  'auth-button-hover-transition': `all ${MOTION_VARIABLES['motion-duration-fast']} ${MOTION_VARIABLES['motion-easing-ease']}`,
  'auth-modal-enter-animation': `fadeIn ${MOTION_VARIABLES['motion-duration-normal']} ${MOTION_VARIABLES['motion-easing-ease']}`,
  'auth-modal-exit-animation': `fadeOut ${MOTION_VARIABLES['motion-duration-fast']} ${MOTION_VARIABLES['motion-easing-ease']}`,

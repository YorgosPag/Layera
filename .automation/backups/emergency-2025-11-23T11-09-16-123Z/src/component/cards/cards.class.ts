...
// CARD TEXT ALIGNMENT CSS - Για κάρτες με κείμενα (όπως τα modals)
export const LAYERA_CARD_TEXT_ALIGNMENT_CSS = `
/* 🃏 LAYERA CARD TEXT ALIGNMENT CLASSES */

/* Card με uniform size (όπως τα modals) και text alignment */
.layera-card.layera-card-uniform {
...
/* Vertical Text Alignment - Κάθετη στοίχιση κειμένου */
.layera-card.layera-card-uniform.layera-card-text-vertical-top {
...
.layera-card.layera-card-uniform.layera-card-text-vertical-middle {
  text-align: center !important;
  display: flex !important;
...
.layera-card.layera-card-uniform.layera-card-text-vertical-bottom {
  text-align: center !important;
  display: flex !important;
...
/* Horizontal Text Alignment - Οριζόντια στοίχιση κειμένου */
.layera-card.layera-card-uniform.layera-card-text-horizontal-left {
  text-align: left !important;
  display: flex !important;
  align-items: center !important;
  justify-content: flex-start !important;
  padding-left: var(--layera-spacing-2) !important;
}

.layera-card.layera-card-uniform.layera-card-text-horizontal-center {
  text-align: center !important;
  display: flex !important;
  align-items: center !important;
  justify-content: center !important;
...
.layera-card.layera-card-uniform.layera-card-text-horizontal-right {
  text-align: right !important;
  display: flex !important;
  align-items: center !important;
  justify-content: flex-end !important;
  padding-right: var(--layera-spacing-2) !important;
}

/* Card Text Center Class - Για compatibility με άλλα components */
...
/* LIVE PREVIEW VARIABLES - Real-time color updates από color pickers */
/* Κάρτες με data-variant="primary" χρησιμοποιούν το --layera-live-card-primary */
.layera-card[data-variant="primary"] {
  background-color: var(--layera-live-card-primary, var(--layera-colors-primary-500)) !important;
}

.layera-card[data-variant="secondary"] {
  background-color: var(--layera-live-card-secondary, var(--layera-colors-secondary-500)) !important;
}

.layera-card[data-variant="success"] {
  background-color: var(--layera-live-card-success, var(--layera-colors-success-500)) !important;
}

.layera-card[data-variant="warning"] {
  background-color: var(--layera-live-card-warning, var(--layera-colors-warning-500)) !important;
}

.layera-card[data-variant="error"] {
  background-color: var(--layera-live-card-danger, var(--layera-colors-error-500)) !important;
}

.layera-card[data-variant="info"] {
  background-color: var(--layera-live-card-info, var(--layera-colors-info-500)) !important;
}

/* MODALS & LAYOUT BASE CLASSES - Κληρονομούν από layera-card */
.layera-modal,
.layera-layout {
  display: flex;
  flex-direction: column;
  position: relative;
  overflow: hidden;
  transition: var(--layera-motion-transition-all);
  font-family: var(--layera-typography-font-family-base);
}

/* MODALS LIVE PREVIEW VARIABLES - Ξεχωριστές CSS variables για modals */
.layera-modal[data-variant="primary"] {
  background-color: var(--layera-live-modal-primary, var(--layera-colors-primary-500)) !important;
}

.layera-modal[data-variant="secondary"] {
  background-color: var(--layera-live-modal-secondary, var(--layera-colors-secondary-500)) !important;
}

.layera-modal[data-variant="success"] {
  background-color: var(--layera-live-modal-success, var(--layera-colors-success-500)) !important;
}

.layera-modal[data-variant="warning"] {
  background-color: var(--layera-live-modal-warning, var(--layera-colors-warning-500)) !important;
}

.layera-modal[data-variant="error"] {
  background-color: var(--layera-live-modal-danger, var(--layera-colors-error-500)) !important;
}

.layera-modal[data-variant="info"] {
  background-color: var(--layera-live-modal-info, var(--layera-colors-info-500)) !important;
}

/* LAYOUT LIVE PREVIEW VARIABLES - Ξεχωριστές CSS variables για layout */
.layera-layout[data-variant="primary"] {
  background-color: var(--layera-live-layout-primary, var(--layera-colors-primary-500)) !important;
}

.layera-layout[data-variant="secondary"] {
  background-color: var(--layera-live-layout-secondary, var(--layera-colors-secondary-500)) !important;
}

.layera-layout[data-variant="success"] {
  background-color: var(--layera-live-layout-success, var(--layera-colors-success-500)) !important;
}

.layera-layout[data-variant="warning"] {
  background-color: var(--layera-live-layout-warning, var(--layera-colors-warning-500)) !important;
}

.layera-layout[data-variant="error"] {
  background-color: var(--layera-live-layout-danger, var(--layera-colors-error-500)) !important;
}

.layera-layout[data-variant="info"] {
  background-color: var(--layera-live-layout-info, var(--layera-colors-info-500)) !important;
}

/* MODAL UNIFORM SIZE CLASSES - Ξεχωριστές uniform κλάσεις για modals */
.layera-modal.layera-modal-uniform {
  width: var(--layera-spacing-32) !important;
  height: var(--layera-spacing-20) !important;
  min-width: var(--layera-spacing-32) !important;
  min-height: var(--layera-spacing-20) !important;
...
/* LAYOUT UNIFORM SIZE CLASSES - Ξεχωριστές uniform κλάσεις για layout */
.layera-layout.layera-layout-uniform {
  width: var(--layera-spacing-32) !important;
  height: var(--layera-spacing-20) !important;
  min-width: var(--layera-spacing-32) !important;
  min-height: var(--layera-spacing-20) !important;
...
/* MODAL TEXT ALIGNMENT CLASSES - Ξεχωριστές από cards */
.layera-modal.layera-modal-text-vertical-top {
  text-align: center !important;
  display: flex !important;
  align-items: flex-start !important;
  justify-content: center !important;
...
.layera-modal.layera-modal-text-vertical-middle {
  text-align: center !important;
  display: flex !important;
  align-items: center !important;
  justify-content: center !important;
...
.layera-modal.layera-modal-text-vertical-bottom {
  text-align: center !important;
  display: flex !important;
  align-items: flex-end !important;
  justify-content: center !important;
...
.layera-modal.layera-modal-text-horizontal-left {
  text-align: left !important;
  display: flex !important;
  align-items: center !important;
  justify-content: flex-start !important;
...
.layera-modal.layera-modal-text-horizontal-center {
  text-align: center !important;
  display: flex !important;
  align-items: center !important;
  justify-content: center !important;
...
.layera-modal.layera-modal-text-horizontal-right {
  text-align: right !important;
  display: flex !important;
  align-items: center !important;
  justify-content: flex-end !important;
...
/* LAYOUT TEXT ALIGNMENT CLASSES - Ξεχωριστές από cards */
.layera-layout.layera-layout-text-vertical-middle {
  text-align: center !important;
  display: flex !important;
  align-items: center !important;
  justify-content: center !important;

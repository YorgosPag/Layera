...
export const CARD_VARIABLES = {
  ...
  // Header section
  'card-header-gap': SPACING_VARIABLES['spacing-3'],
  'card-header-margin-bottom': SPACING_VARIABLES['spacing-4'],
  'card-header-padding': `${SPACING_VARIABLES['spacing-4']} ${SPACING_VARIABLES['spacing-4']} 0`,
  ...
  'card-title-margin-bottom': SPACING_VARIABLES['spacing-1'],

  // ENHANCED CARD BACKGROUNDS - COLORFUL CARDS για visibility
  'card-background-default': 'var(--layera-color-semantic-neutral-light)', // ΛΕΥΚΟ για default cards
  'card-background-primary': 'var(--layera-color-semantic-warning-secondary)', // ΚΙΤΡΙΝΟ για primary cards
  'card-background-secondary': 'var(--layera-color-semantic-info-secondary)', // ΜΠΛΕ για secondary cards
  'card-background-success': 'var(--layera-color-semantic-success-secondary)', // ΠΡΑΣΙΝΟ για success cards
  'card-background-warning': 'var(--layera-color-semantic-warning-primary)', // ΠΟΡΤΟΚΑΛΙ για warning cards
  'card-background-error': 'var(--layera-color-semantic-error-secondary)', // ΚΟΚΚΙΝΟ για error cards
  'card-background-neutral': 'var(--layera-color-semantic-neutral-secondary)', // ΓΚΡΙ για neutral cards

  // VISIBLE BORDERS για card definition - 2px solid borders
  'card-border-default': '2px solid var(--layera-color-semantic-neutral-primary)',
  'card-border-primary': '2px solid var(--layera-color-semantic-warning-primary)',
  'card-border-secondary': '2px solid var(--layera-color-semantic-info-primary)',
  'card-border-success': '2px solid var(--layera-color-semantic-success-primary)',
  'card-border-warning': '2px solid var(--layera-color-semantic-warning-primary)',
  'card-border-error': '2px solid var(--layera-color-semantic-error-primary)',
  'card-border-neutral': '2px solid var(--layera-color-semantic-neutral-primary)',

  // CORE CARD VISUAL PROPERTIES για ορατότητα
  'card-padding': SPACING_VARIABLES['spacing-4'], // 16px padding
  'card-margin': SPACING_VARIABLES['spacing-2'], // 8px margin
  'card-min-height': '120px', // Minimum height για consistency
  'card-display': 'block',
  ...
  'card-subtitle-margin-bottom': 'SPACING_VARIABLES['spacing-2']',
  ...
  // Icon styling
  'card-icon-size': 'SPACING_VARIABLES['spacing-6']',
  'card-icon-color': 'var(--layera-color-text-accent)',

  // Content area
  'card-content-padding': '0 SPACING_VARIABLES['spacing-4']',
  'card-content-gap': 'SPACING_VARIABLES['spacing-3']',

  // Footer section
  'card-footer-margin-top': 'SPACING_VARIABLES['spacing-4']',
  'card-footer-padding': 'SPACING_VARIABLES['spacing-4']',
  'card-footer-padding-top': 'SPACING_VARIABLES['spacing-3']',
  'card-footer-border': '1px solid var(--layera-color-border-muted)',
  'card-footer-background': 'var(--layera-color-surface-muted)',

  // Actions area
  'card-actions-gap': 'SPACING_VARIABLES['spacing-2']',
  'card-actions-margin': 'SPACING_VARIABLES['spacing-2']',
  ...
  'card-focus-outline-offset': SPACING_VARIABLES['spacing-0-5'], // 2px
...
export const RESPONSIVE_CARD_VARIABLES = {
  ...
  mobile: {
    'card-padding': 'SPACING_VARIABLES['spacing-3']',
    'card-margin': 'SPACING_VARIABLES['spacing-2']',
  ...
  // Tablet adaptations
  tablet: {
    'card-padding': 'SPACING_VARIABLES['spacing-4']',
    'card-margin': 'SPACING_VARIABLES['spacing-3']',
    'card-border-radius': 'var(--layera-global-borderRadius-md)',
    'card-title-font-size': 'var(--layera-fontSize-lg)',
  ...
  desktop: {
    'card-padding': 'SPACING_VARIABLES['spacing-5']',
    'card-margin': 'SPACING_VARIABLES['spacing-4']',

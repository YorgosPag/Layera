...
export const MODAL_VARIABLES = {
  ...
  // ENTERPRISE TEXT ALIGNMENT - Modals
  'modal-text-align-horizontal-left': 'var(--layera-core-text-align-left)',
  'modal-text-align-horizontal-center': 'var(--layera-core-text-align-center)',
  'modal-text-align-horizontal-right': 'var(--layera-core-text-align-right)',
  'modal-text-align-horizontal-justify': 'var(--layera-core-text-align-justify)',
  'modal-text-align-vertical-top': 'var(--layera-core-text-align-vertical-top)',
  'modal-text-align-vertical-middle': 'var(--layera-core-text-align-vertical-middle)',
  'modal-text-align-vertical-bottom': 'var(--layera-core-text-align-vertical-bottom)',
} as const;

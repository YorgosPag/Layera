...
export const BUTTON_VARIABLES = {
  ...
  'button-text-align-horizontal-left': 'var(--layera-core-text-align-left)',
  'button-text-align-horizontal-center': 'var(--layera-core-text-align-center)',
  'button-text-align-horizontal-right': 'var(--layera-core-text-align-right)',
  'button-text-align-horizontal-justify': 'var(--layera-core-text-align-justify)',
  'button-text-align-vertical-top': 'var(--layera-core-text-align-vertical-top)',
  'button-text-align-vertical-middle': 'var(--layera-core-text-align-vertical-middle)',
  'button-text-align-vertical-bottom': 'var(--layera-core-text-align-vertical-bottom)',
} as const;

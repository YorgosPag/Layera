...
export const CARD_VARIANTS = {
  ...
  padding: {
    ...
    sm: {
      padding: 'SPACING_VARIABLES['spacing-3']',
    },
    md: {
      padding: 'SPACING_VARIABLES['spacing-4']',
    },
    lg: {
      padding: 'SPACING_VARIABLES['spacing-6']',
    },
  },
} as const;
...
export const CARD_RESPONSIVE_VARIANTS = {
  ...
  desktop: {
    padding: 'SPACING_VARIABLES['spacing-5']',
    borderRadius: 'var(--layera-global-borderRadius-lg)',
  },
} as const;
...
export const CARD_ANIMATION_VARIANTS = {
  entrance: {
    fadeIn: {
      ...
      duration: 'var(--layera-motion-duration-normal)',
      easing: 'var(--layera-motion-easing-ease-out)',
    },
    slideUp: {
      from: { transform: 'translateY(100%)' },
      to: { transform: 'translateY(0)' },
      duration: 'var(--layera-motion-duration-slow)',
      easing: 'var(--layera-motion-easing-bounce)',
    },
  },
  hover: {
    lift: {
      duration: 'var(--layera-motion-duration-fast)',
      easing: 'var(--layera-motion-easing-ease)',
    },
  },
  loading: {
    pulse: {

...
.layera-accordion__header {
  ...
  cursor: pointer;
  transition: background-color var(--layera-motion-duration-fast);
  display: flex;
...
.layera-accordion__content {
  ...
  animation: slideDown var(--layera-motion-duration-normal) var(--layera-motion-easing-ease-out);
}

.layera-accordion__icon {
  transition: transform var(--layera-motion-duration-fast);
}
...
.layera-tabs__trigger {
  ...
  cursor: pointer;
  position: relative;
  transition: all var(--layera-motion-duration-fast);
...
.layera-tabs__content {
  ...
  animation: fadeIn var(--layera-motion-duration-normal);
}
...
.layera-collapsible__content {
  ...
  animation: slideDown var(--layera-motion-duration-normal);
}

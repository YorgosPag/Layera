...
export const RESPONSIVE_ICON_VARIANTS = {
  mobile: {
    navigation: {
      size: ICON_SIZE_SCALE.lg,  // Μεγαλύτερα στο mobile για touch
      color: ICON_TOKENS.colors.neutral,
      interactive: true,
    },
    action: {
...
export type IconVariantCategory = keyof typeof ICON_VARIANTS.status | keyof typeof ICON_VARIANTS.action | keyof typeof ICON_VARIANTS.navigation;
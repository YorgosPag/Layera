...
export const ICON_SEMANTIC_VARIANTS = {
  ...
  // Navigation icons
  navigation: {
    menu: { color: 'neutral' as IconColor, size: 'md' as IconSize, interactive: true },
    close: { color: 'neutral' as IconColor, size: 'md' as IconSize, interactive: true },
    back: { color: 'neutral' as IconColor, size: 'md' as IconSize, interactive: true },
  },
} as const;

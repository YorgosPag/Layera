...
import { BORDER_SEMANTIC_VARIABLES } from './border.variables';
...
export class BorderSemanticSystem {
  // Semantic tokens
  static readonly colorSemantics = BORDER_SEMANTIC_VARIABLES;
  static readonly semantics = BORDER_SEMANTIC_VARIABLES;

...
export const CARD_VARIABLES = {
  ...
  'card-transition': 'var(--layera-motion-duration-normal) var(--layera-motion-easing-ease)',
  'card-transition-transform': 'transform var(--layera-motion-duration-fast) var(--layera-motion-easing-ease)',
  'card-transition-shadow': 'box-shadow var(--layera-motion-duration-normal) var(--layera-motion-easing-ease)',
  ...
  // Header section
  'card-header-gap': 'var(--layera-global-spacing-3)',
  'card-header-margin-bottom': 'var(--layera-global-spacing-4)',
  'card-header-padding': 'var(--layera-global-spacing-4) var(--layera-global-spacing-4) 0',
  ...
  'card-title-margin-bottom': 'var(--layera-global-spacing-1)',
  ...
  'card-subtitle-margin-bottom': 'var(--layera-global-spacing-2)',
  ...
  // Icon styling
  'card-icon-size': 'var(--layera-global-spacing-6)',
  'card-icon-color': 'var(--layera-color-text-accent)',

  // Content area
  'card-content-padding': '0 var(--layera-global-spacing-4)',
  'card-content-gap': 'var(--layera-global-spacing-3)',

  // Footer section
  'card-footer-margin-top': 'var(--layera-global-spacing-4)',
  'card-footer-padding': 'var(--layera-global-spacing-4)',
  'card-footer-padding-top': 'var(--layera-global-spacing-3)',
  'card-footer-border': '1px solid var(--layera-color-border-muted)',
  'card-footer-background': 'var(--layera-color-surface-muted)',

  // Actions area
  'card-actions-gap': 'var(--layera-global-spacing-2)',
  'card-actions-margin': 'var(--layera-global-spacing-2)',

  // Loading & empty states
  'card-loading-background': 'var(--layera-color-surface-muted)',
  'card-loading-animation': 'pulse var(--layera-motion-duration-slow) infinite',
...
export const SPECIALIZED_CARD_VARIABLES = {
  ...
  'job-card-badge-background': 'var(--layera-color-success-100)',
  'job-card-badge-color': 'var(--layera-color-success-700)',
...
export const CARD_STATE_VARIABLES = {
  ...
  loading: {
    ...
    'card-loading-shimmer-animation': 'shimmer var(--layera-motion-duration-slow) infinite linear',
  },
...
export const RESPONSIVE_CARD_VARIABLES = {
  ...
  mobile: {
    'card-padding': 'var(--layera-global-spacing-3)',
    'card-margin': 'var(--layera-global-spacing-2)',
  ...
  // Tablet adaptations
  tablet: {
    'card-padding': 'var(--layera-global-spacing-4)',
    'card-margin': 'var(--layera-global-spacing-3)',
    'card-border-radius': 'var(--layera-global-borderRadius-md)',
    'card-title-font-size': 'var(--layera-fontSize-lg)',
  ...
  desktop: {
    'card-padding': 'var(--layera-global-spacing-5)',
    'card-margin': 'var(--layera-global-spacing-4)',

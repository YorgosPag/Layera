...
import { DRAGGABLE_VARIABLES } from '../draggable/draggable.variables';
...
export const FILES_VARIABLES = {
  ...
  // FILE UPLOAD ZONE TOKENS
  'upload-zone-background': BACKGROUND_VARIABLES['background-subtle'],
  'upload-zone-background-hover': BACKGROUND_VARIABLES['background-hover'],
  'upload-zone-background-active': BACKGROUND_VARIABLES['background-active'],
  'upload-zone-background-error': BACKGROUND_VARIABLES['background-error'],
  'upload-zone-background-success': BACKGROUND_VARIABLES['background-success'],

  'upload-zone-border': BORDER_SEMANTIC_VARIABLES['border-subtle'],
  'upload-zone-border-hover': BORDER_SEMANTIC_VARIABLES['border-interactive'],
  'upload-zone-border-active': BORDER_SEMANTIC_VARIABLES['border-focus'],
  'upload-zone-border-error': BORDER_SEMANTIC_VARIABLES['border-error'],
  'upload-zone-border-success': BORDER_SEMANTIC_VARIABLES['border-success'],
  'upload-zone-border-style': 'dashed',
  'upload-zone-border-radius': BORDER_VARIABLES['border-radius-12'],

  'upload-zone-padding': `${SPACING_VARIABLES['spacing-12']} ${SPACING_VARIABLES['spacing-8']}`,
  'upload-zone-min-height': SPACING_VARIABLES['spacing-32'],
  'upload-zone-text-color': TEXT_VARIABLES['text-secondary'],
  'upload-zone-text-hover': TEXT_VARIABLES['text-primary'],
  'upload-zone-transition': MOTION_VARIABLES['transition-normal'],
  ...
  // DRAG & DROP TOKENS (reference to draggable component)
  'drop-indicator-color': DRAGGABLE_VARIABLES['drop-indicator-color'],
  'drop-indicator-width': DRAGGABLE_VARIABLES['drop-indicator-width'],
  'drop-indicator-style': DRAGGABLE_VARIABLES['drop-indicator-style'],
  'drop-overlay-background': DRAGGABLE_VARIABLES['drag-overlay-background'],
  'drop-overlay-backdrop': DRAGGABLE_VARIABLES['drag-overlay-backdrop-filter'],

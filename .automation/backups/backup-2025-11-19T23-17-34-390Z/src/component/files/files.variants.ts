...
export const UPLOAD_ZONE_VARIANTS = {
  // Default upload zone
  default: {
    background: FILES_VARIABLES['upload-zone-background'],
    border: FILES_VARIABLES['upload-zone-border'],
    borderStyle: FILES_VARIABLES['upload-zone-border-style'],
    borderRadius: FILES_VARIABLES['upload-zone-border-radius'],
    padding: FILES_VARIABLES['upload-zone-padding'],
    minHeight: FILES_VARIABLES['upload-zone-min-height'],
    textColor: FILES_VARIABLES['upload-zone-text-color'],
...
export const FILE_SIZE_VARIANTS = {
  ...
  large: {
    ...
    nameSize: '16px',
    infoSize: '14px',
    padding: `${SPACING_VARIABLES['spacing-4']} ${SPACING_VARIABLES['spacing-6']}`,

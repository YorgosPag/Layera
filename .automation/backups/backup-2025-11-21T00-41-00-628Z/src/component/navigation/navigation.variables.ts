...
export const NAVIGATION_VARIABLES = {
  ...
  'header-text-align-horizontal-left': 'left',
  'header-text-align-horizontal-center': 'center',
  'header-text-align-horizontal-right': 'right',
  'header-text-align-horizontal-justify': 'justify',
  'header-text-align-vertical-top': 'top',
  'header-text-align-vertical-middle': 'middle',
  'header-text-align-vertical-bottom': 'bottom',
} as const;

...
export const MODAL_VARIABLES = {
  ...
  'modal-text-align-horizontal-left': 'left',
  'modal-text-align-horizontal-center': 'center',
  'modal-text-align-horizontal-right': 'right',
  'modal-text-align-horizontal-justify': 'justify',
  'modal-text-align-vertical-top': 'top',
  'modal-text-align-vertical-middle': 'middle',
  'modal-text-align-vertical-bottom': 'bottom',
} as const;

...
export const INPUT_VARIABLES = {
  ...
  'input-text-align-horizontal-left': 'left',
  'input-text-align-horizontal-center': 'center',
  'input-text-align-horizontal-right': 'right',
  'input-text-align-horizontal-justify': 'justify',
  'input-text-align-vertical-top': 'top',
  'input-text-align-vertical-middle': 'middle',
  'input-text-align-vertical-bottom': 'bottom',
} as const;

...
export const CARD_VARIABLES = {
  ...
  // ENTERPRISE TEXT ALIGNMENT - Cards
  'card-text-align-horizontal-left': 'left',
  'card-text-align-horizontal-center': 'center',
  'card-text-align-horizontal-right': 'right',
  'card-text-align-horizontal-justify': 'justify',
  'card-text-align-vertical-top': 'top',
  'card-text-align-vertical-middle': 'middle',
  'card-text-align-vertical-bottom': 'bottom',

...
export const LAYOUT_TEXT_ALIGN = {
  'layout-text-align-horizontal-left': 'left',
  'layout-text-align-horizontal-center': 'center',
  'layout-text-align-horizontal-right': 'right',
  'layout-text-align-horizontal-justify': 'justify',
  'layout-text-align-vertical-top': 'top',
  'layout-text-align-vertical-middle': 'middle',
  'layout-text-align-vertical-bottom': 'bottom',
} as const;

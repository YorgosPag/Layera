...
export const INPUT_VARIABLES = {
  ...
  // ENTERPRISE TEXT ALIGNMENT - Inputs
  'input-text-align-horizontal-left': 'var(--layera-core-text-align-left)',
  'input-text-align-horizontal-center': 'var(--layera-core-text-align-center)',
  'input-text-align-horizontal-right': 'var(--layera-core-text-align-right)',
  'input-text-align-horizontal-justify': 'var(--layera-core-text-align-justify)',
  'input-text-align-vertical-top': 'var(--layera-core-text-align-vertical-top)',
  'input-text-align-vertical-middle': 'var(--layera-core-text-align-vertical-middle)',
  'input-text-align-vertical-bottom': 'var(--layera-core-text-align-vertical-bottom)',
} as const;
